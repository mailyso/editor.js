...
let Ks = (n = 21) => crypto.getRandomValues(new Uint8Array(n)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
var ki = /* @__PURE__ */ ((n) => (n.VERBOSE = "VERBOSE", n.INFO = "INFO", n.WARN = "WARN", n.ERROR = "ERROR", n))(ki || {});
const w = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
function ot(n, e, t = "log", o, i = "color: inherit") {
...
const M = ot.bind(window, !1), ne = ot.bind(window, !0);
function Be(n) {
  return Object.prototype.toString.call(n).match(/\s([a-zA-Z]+)/)[1].toLowerCase();
}
function P(n) {
  return Be(n) === "function" || Be(n) === "asyncfunction";
}
function z(n) {
  return Be(n) === "object";
}
...
async function Xs(n, e = () => {
  ...
  async function o(i, s, r) {
    try {
      await i.function(i.data), await s(ei(i.data) ? {} : i.data);
    } catch {
      r(ei(i.data) ? {} : i.data);
    }
  }
...
function So(n, ...e) {
  ...
  if (z(n) && z(t))
    for (const o in t)
      z(t[o]) ? (n[o] || Object.assign(n, { [o]: {} }), So(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
  return So(n, ...e);
}
function Wo(n) {
  const e = Zs();
...
const wi = 650;
function De() {
  return window.matchMedia(`(max-width: ${wi}px)`).matches;
}
const Oo = typeof window < "u" && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1);
function nr(n, e) {
  const t = Array.isArray(n) || z(n), o = Array.isArray(e) || z(e);
...
class h {
  ...
  static findAllInputs(e) {
    return Ei(e.querySelectorAll(h.allInputsSelector)).reduce((t, o) => h.isNativeInput(o) || h.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...h.getDeepestBlockElements(o)], []);
  }
  /**
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  static isFragment(e) {
    return Jn(e) ? !1 : e && e.nodeType && e.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
  }
  /**
  ...
  static containsOnlyInlineElements(e) {
    let t;
    me(e) ? (t = document.createElement("div"), t.innerHTML = e) : t = e;
   ...
   */
  static getHolder(e) {
    return me(e) ? document.getElementById(e) : e;
  }
  /**
...
class nt {
   ...
   */
  emit(e, t) {
    ie(this.subscribers) || !this.subscribers[e] || this.subscribers[e].reduce((o, i) => {
      const s = i(o);
      return s !== void 0 ? s : o;
    }, t);
  }
...
class I {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    ...
    }, this.mutableListenerIds = [], new.target === I)
...
const Ao = "redactor dom changed", vt = "block changed", Si = "fake cursor is about to be toggled", Ii = "fake cursor have been set", Ze = "editor mobile layout toggled";
function Lo(n, e) {
...
function Oi(n, e) {
  return Object.entries(n).some(([t, o]) => e[t] && nr(e[t], o));
}
async function Ai(n, e) {
  const o = (await n.save()).data, i = e.find((s) => s.name === n.name);
  return i !== void 0 && !Lo(i, "export") ? [] : e.reduce((s, r) => {
    if (!Lo(r, "import") || r.toolbox === void 0)
      return s;
    const a = r.toolbox.filter((l) => {
      if (ie(l) || l.icon === void 0)
        return !1;
      if (l.data !== void 0) {
        if (Oi(l.data, o))
          return !1;
...
function oi(n, e) {
  return n.mergeable ? n.name === e.name ? !0 : kt(e, "export") && kt(n, "import") : !1;
}
function ur(n, e) {
  const t = e == null ? void 0 : e.export;
  return P(t) ? t(n) : me(t) ? n[t] : (t !== void 0 && M("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function ni(n, e, t) {
  const o = e == null ? void 0 : e.import;
  return P(o) ? o(n, t) : me(o) ? {
    [o]: n
  } : (o !== void 0 && M("Conversion «import» property must be a string or function. String means key of tool data to import. Function accepts a imported string and return composed tool data."), {});
}
var N = /* @__PURE__ */ ((n) => (n.Default = "default", n.Separator = "separator", n.Html = "html", n))(N || {}), ge = /* @__PURE__ */ ((n) => (n.APPEND_CALLBACK = "appendCallback", n.RENDERED = "rendered", n.MOVED = "moved", n.UPDATED = "updated", n.REMOVED = "removed", n.ON_PASTE = "onPaste", n))(ge || {});
class U extends nt {
  /**
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      l || c ? d = !0 : d = !(a.length > 0 && a.every((p) => {
        const { addedNodes: m, removedNodes: f, target: b } = p;
        return [
          ...Array.from(m),
          ...Array.from(f),
          b
        ].some((B) => (h.isElement(B) || (B = B.parentElement), B && B.closest('[data-mutation-free="true"]') !== null));
      })), d && (this.dropInputsCache(), this.updateCurrentInput(), this.toggleInputsEmptyMark(), this.call(
        "updated"
        /* UPDATED */
      ), this.emit("didMutated", this));
    }, this.name = o.name, this.id = e, this.settings = o.settings, this.config = o.settings.config || {}, this.editorEventBus = r || null, this.blockAPI = new fe(this), this.tool = o, this.toolInstance = o.create(t, this.blockAPI, i), this.tunes = o.tunes, this.composeTunes(s), this.holder = this.compose(), window.requestIdleCallback(() => {
   ...
   */
  get data() {
    return this.save().then((e) => e && !ie(e.data) ? e.data : {});
  }
  /**
   ...
   */
  get mergeable() {
    return P(this.toolInstance.merge);
  }
  /**
  ...
  set selected(e) {
    var i, s;
    this.holder.classList.toggle(U.CSS.selected, e);
    const t = e === !0 && k.isRangeInsideContainer(this.holder), o = e === !1 && k.isFakeCursorInsideContainer(this.holder);
    (t || o) && ((i = this.editorEventBus) == null || i.emit(Si, { state: e }), t ? k.addFakeCursor() : k.removeFakeCursor(this.holder), (s = this.editorEventBus) == null || s.emit(Ii, { state: e }));
  }
  /**
   ...
   */
  get selected() {
    return this.holder.classList.contains(U.CSS.selected);
  }
  /**
   * Set stretched state
   *
   ...
   */
  set stretched(e) {
    this.holder.classList.toggle(U.CSS.wrapperStretched, e);
  }
  /**
   ...
   */
  get stretched() {
    return this.holder.classList.contains(U.CSS.wrapperStretched);
  }
  /**
   ...
   */
  set dropTarget(e) {
    this.holder.classList.toggle(U.CSS.dropTarget, e);
  }
  /**
  ...
  async save() {
    ...
    return Promise.resolve(e).then((s) => (i = window.performance.now(), {
      ...
      M(`Saving process for ${this.name} tool failed due to the ${s}`, "log", "red");
    });
  }
  /**
   ...
   */
  destroy() {
    this.unwatchBlockMutations(), this.removeInputEvents(), super.destroy(), P(this.toolInstance.destroy) && this.toolInstance.destroy();
  }
  /**
   * Tool could specify several entries to be displayed at the Toolbox (for example, "Heading 1", "Heading 2", "Heading 3")
   * This method returns the entry that is related to the Block (depended on the Block data)
  ...
  async getActiveToolboxEntry() {
    ...
    return o == null ? void 0 : o.find((i) => Oi(i.data, t));
  }
  /**
  ...
  async exportDataAsString() {
    ...
    return ur(e, this.tool.conversionConfig);
  }
  /**
   ...
   */
  compose() {
    const e = h.make("div", U.CSS.wrapper), t = h.make("div", U.CSS.content), o = this.toolInstance.render();
    ...
    return [...this.tunesInstances.values(), ...this.defaultTunesInstances.values()].forEach((s) => {
      if (P(s.wrap))
        try {
          ...
          M(`Tune ${s.constructor.name} wrap method throws an Error %o`, "warn", r);
        }
    }), e.appendChild(i), e;
  }
  /**
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (t) => {
      const { mutations: o } = t;
      o.some((s) => dr(s, this.toolRenderedElement)) && this.didMutated(o);
    }, (e = this.editorEventBus) == null || e.on(Ao, this.redactorDomChangedCallback);
  }
  /**
  ...
  unwatchBlockMutations() {
    var e;
    (e = this.editorEventBus) == null || e.off(Ao, this.redactorDomChangedCallback);
  }
  /**
...
class hr extends I {
  constructor() {
    super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, s, r, a) => {
      ...
      return this.Editor.BlockManager.insertMany(o, t), o.map((i) => new fe(i));
    };
  }
  /**
   * Available methods
  ...
  getBlockIndex(e) {
    ...
    if (!t) {
      ne("There is no block with id `" + e + "`", "warn");
      return;
    }
  ...
  getBlockByIndex(e) {
    ...
    if (t === void 0) {
      ne("There is no block at index `" + e + "`", "warn");
      return;
    }
    return new fe(t);
  }
  ...
  getById(e) {
    const t = this.Editor.BlockManager.getBlockById(e);
    return t === void 0 ? (ne("There is no block with id `" + e + "`", "warn"), null) : new fe(t);
  }
  /**
  ...
  getBlockByElement(e) {
    ...
    if (t === void 0) {
      ne("There is no block corresponding to element `" + e + "`", "warn");
      return;
    }
    return new fe(t);
  }
...
class Ko extends I {
  ...
  get methods() {
    return {
      t: () => {
        ne("I18n.t() method can be accessed only from Tools", "warn");
      }
    };
  }
  /**
...
class mr extends I {
  ...
  get methods() {
    return {
      ...
      collab: this.Editor.CollabAPI.methods
    };
  }
  /**
          ...
          return this.map(function(r) {
            var a = function(l, c) {
              ...
              if (c && typeof btoa == "function") {
                var p = (f = u, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(f)))) + " */"), m = u.sources.map(function(b) {
                  return "/*# sourceURL=" + u.sourceRoot + b + " */";
                });
                return [d].concat(m).concat([p]).join(`
`);
              }
              var f;
              return [d].join(`
`);
      ...
      function f(y, v) {
        for (var E = 0; E < y.length; E++) {
          ...
          if (_) {
            _.refs++;
            for (var A = 0; A < _.parts.length; A++)
              _.parts[A](O.parts[A]);
            for (; A < O.parts.length; A++)
              _.parts.push($(O.parts[A], v));
          } else {
            var H = [];
            for (A = 0; A < O.parts.length; A++)
              H.push($(O.parts[A], v));
            a[O.id] = { id: O.id, refs: 1, parts: H };
          }
        }
      }
      function b(y, v) {
        for (var E = [], O = {}, _ = 0; _ < y.length; _++) {
          var A = y[_], H = v.base ? A[0] + v.base : A[0], S = { css: A[1], media: A[2], sourceMap: A[3] };
          O[H] ? O[H].parts.push(S) : E.push(O[H] = { id: H, parts: [S] });
        }
        return E;
      }
      function T(y, v) {
        ...
        var O = p[p.length - 1];
        if (y.insertAt === "top")
          O ? O.nextSibling ? E.insertBefore(v, O.nextSibling) : E.appendChild(v) : E.insertBefore(v, E.firstChild), p.push(v);
...
`);
          var _ = c(y.insertInto + " " + y.insertAt.before);
          E.insertBefore(v, _);
        }
      }
      function B(y) {
      ...
      function x(y) {
        ...
        return y.attrs.type === void 0 && (y.attrs.type = "text/css"), ee(v, y.attrs), T(y, v), v;
      }
      function ee(y, v) {
      ...
      function $(y, v) {
        ...
        if (v.singleton) {
          var H = u++;
          E = d || (d = x(v)), O = se.bind(null, E, H, !1), _ = se.bind(null, E, H, !0);
        } else
          y.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (E = function(S) {
            var F = document.createElement("link");
            return S.attrs.type === void 0 && (S.attrs.type = "text/css"), S.attrs.rel = "stylesheet", ee(F, S.attrs), T(S, F), F;
          }(v), O = (function(S, F, re) {
            var we = re.css, uo = re.sourceMap, Us = F.convertToAbsoluteUrls === void 0 && uo;
            (F.convertToAbsoluteUrls || Us) && (we = m(we)), uo && (we += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(uo)))) + " */");
            var zs = new Blob([we], { type: "text/css" }), Zn = S.href;
            S.href = URL.createObjectURL(zs), Zn && URL.revokeObjectURL(Zn);
          }).bind(null, E, v), _ = function() {
            B(E), E.href && URL.revokeObjectURL(E.href);
          }) : (E = x(v), O = (function(S, F) {
            var re = F.css, we = F.media;
            if (we && S.setAttribute("media", we), S.styleSheet)
              S.styleSheet.cssText = re;
            else {
              for (; S.firstChild; )
                S.removeChild(S.firstChild);
              S.appendChild(document.createTextNode(re));
            }
          }).bind(null, E), _ = function() {
            B(E);
          });
        return O(y), function(S) {
          if (S) {
            if (S.css === y.css && S.media === y.media && S.sourceMap === y.sourceMap)
              return;
            O(y = S);
          } else
            _();
      ...
      t.exports = function(y, v) {
        ...
        var E = b(y, v);
        return f(E, v), function(O) {
          for (var _ = [], A = 0; A < E.length; A++) {
            var H = E[A];
            (S = a[H.id]).refs--, _.push(S);
          }
          for (O && f(b(O, v), v), A = 0; A < _.length; A++) {
            var S;
            if ((S = _[A]).refs === 0) {
      ...
      var L, V = (L = [], function(y, v) {
        return L[y] = v, L.filter(Boolean).join(`
`);
      });
      function se(y, v, E, O) {
        var _ = E ? "" : O.css;
        if (y.styleSheet)
          y.styleSheet.cssText = V(v, _);
        else {
          var A = document.createTextNode(_), H = y.childNodes;
          H[v] && y.removeChild(H[v]), H.length ? y.insertBefore(A, H[v]) : y.appendChild(A);
        }
      }
    }, function(t, o) {
      t.exports = function(i) {
        ...
        return i.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(l, c) {
          var d, u = c.trim().replace(/^"(.*)"$/, function(p, m) {
            return m;
      ...
      var s, r, a, l, c, d, u, p, m;
      t.exports = (s = "cdx-notifies", r = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", d = "cdx-notify__input", u = "cdx-notify__button", p = "cdx-notify__btns-wrapper", { alert: m = function(f) {
        var b = document.createElement("DIV"), T = document.createElement("DIV"), B = f.message, x = f.style;
        return b.classList.add(r), x && b.classList.add(r + "--" + x), b.innerHTML = B, T.classList.add(a), T.addEventListener("click", b.remove.bind(b)), b.appendChild(T), b;
      }, confirm: function(f) {
        var b = m(f), T = document.createElement("div"), B = document.createElement("button"), x = document.createElement("button"), ee = b.querySelector("." + a), $ = f.cancelHandler, L = f.okHandler;
        return T.classList.add(p), B.innerHTML = f.okText || "Confirm", x.innerHTML = f.cancelText || "Cancel", B.classList.add(u), x.classList.add(u), B.classList.add(l), x.classList.add(c), $ && typeof $ == "function" && (x.addEventListener("click", $), ee.addEventListener("click", $)), L && typeof L == "function" && B.addEventListener("click", L), B.addEventListener("click", b.remove.bind(b)), x.addEventListener("click", b.remove.bind(b)), T.appendChild(B), T.appendChild(x), b.appendChild(T), b;
      }, prompt: function(f) {
        var b = m(f), T = document.createElement("div"), B = document.createElement("button"), x = document.createElement("input"), ee = b.querySelector("." + a), $ = f.cancelHandler, L = f.okHandler;
        return T.classList.add(p), B.innerHTML = f.okText || "Ok", B.classList.add(u), B.classList.add(l), x.classList.add(d), f.placeholder && x.setAttribute("placeholder", f.placeholder), f.default && (x.value = f.default), f.inputType && (x.type = f.inputType), $ && typeof $ == "function" && ee.addEventListener("click", $), L && typeof L == "function" && B.addEventListener("click", function() {
          L(x.value);
        }), B.addEventListener("click", b.remove.bind(b)), T.appendChild(x), T.appendChild(B), b.appendChild(T), b;
      }, getWrapper: function() {
...
(function(n, e) {
  (function(t, o) {
    ...
    function t(u) {
      var p = u.tags, m = Object.keys(p), f = m.map(function(b) {
        return typeof p[b];
      }).every(function(b) {
    ...
    t.prototype.clean = function(u) {
      ...
      return m.innerHTML = u, this._sanitize(p, m), m.innerHTML;
    }, t.prototype._sanitize = function(u, p) {
      var m = a(u, p), f = m.firstChild();
      if (f)
        do {
          ...
          var b = r(f), T;
          b && (T = Array.prototype.some.call(f.childNodes, i));
          var B = !!p.parentNode, x = i(p) && i(f) && B, ee = f.nodeName.toLowerCase(), $ = l(this.config, ee, f), L = b && T;
          if (L || c(f, $) || !this.config.keepNestedBlockElements && x) {
          ...
          for (var V = 0; V < f.attributes.length; V += 1) {
            var se = f.attributes[V];
            d(se, $, f) && (f.removeAttribute(se.name), V = V - 1);
          }
          this._sanitize(u, f);
    ...
    function l(u, p, m) {
      return typeof u.tags[p] == "function" ? u.tags[p](m) : u.tags[p];
    }
    function c(u, p) {
    ...
    function d(u, p, m) {
      ...
      return p === !0 ? !1 : typeof p[f] == "function" ? !p[f](u.value, m) : typeof p[f] > "u" || p[f] === !1 ? !0 : typeof p[f] == "string" ? p[f] !== u.value : !1;
    }
    return t;
  });
})(_i);
var xr = _i.exports;
const Cr = /* @__PURE__ */ Jt(xr);
function Yo(n, e) {
  return n.map((t) => {
    const o = P(e) ? e(t.tool) : e;
    return ie(o) || (t.data = Vo(t.data, o)), t;
  });
}
function ce(n, e = {}) {
  const t = {
  ...
  return new Cr(t).clean(n);
}
function Vo(n, e) {
  return Array.isArray(n) ? Br(n, e) : z(n) ? Sr(n, e) : me(n) ? Ir(n, e) : n;
}
function Br(n, e) {
...
function Sr(n, e) {
  ...
  for (const o in n) {
    if (!Object.prototype.hasOwnProperty.call(n, o))
      continue;
    const i = n[o], s = Or(e[o]) ? e[o] : e;
    t[o] = Vo(i, s);
  }
  return t;
}
function Ir(n, e) {
  return z(e) ? ce(n, e) : e === !1 ? ce(n, {}) : n;
}
function Or(n) {
  return z(n) || qs(n) || P(n);
}
...
class Lr extends I {
  ...
  save() {
    ...
    return this.Editor.ReadOnly.isEnabled ? (ne(e, "warn"), Promise.reject(new Error(e))) : this.Editor.Saver.save();
  }
}
class _r extends I {
  constructor() {
...
class Pr extends I {
  ...
  toggleBlockSettings(e) {
    if (this.Editor.BlockManager.currentBlockIndex === -1) {
      ne("Could't toggle the Toolbar because there is no block selected ", "warn");
      return;
    }
  ...
  toggleToolbox(e) {
    if (this.Editor.BlockManager.currentBlockIndex === -1) {
      ne("Could't toggle the Toolbox because there is no block selected ", "warn");
      return;
    }
...
var Dr = Mi.exports;
const Rr = /* @__PURE__ */ Jt(Dr);
let G = null;
function qo() {
  G || (G = new Rr());
}
function Hr(n, e, t) {
  qo(), G == null || G.show(n, e, t);
}
function yt(n = !1) {
  qo(), G == null || G.hide(n);
}
function Et(n, e, t) {
  qo(), G == null || G.onHover(n, e, t);
}
function jr() {
...
class Ur extends I {
  ...
  get methods() {
    return {
      disableObserver: () => this.disableObserver(),
      enableObserver: () => this.enableObserver(),
      withRemoteApply: (e) => this.withRemoteApply(e),
      onBlockChange: (e) => this.onBlockChange(e),
      getBlockContentRoot: (e) => this.getBlockContentRoot(e)
    };
  }
  /**
  ...
  onBlockChange(e) {
    ...
    return this.eventsDispatcher.on(vt, t), () => {
      this.eventsDispatcher.off(vt, t);
    };
  }
  /**
  ...
  getBlockContentRoot(e) {
    ...
    if (!o)
      return null;
    const i = t.firstInput;
    return i || o.querySelector('[contenteditable="true"]');
  }
}
function Ni(n, e) {
  const t = {};
  return Object.entries(n).forEach(([o, i]) => {
    if (z(i)) {
      const s = e ? `${e}.${o}` : o;
      Object.values(i).every((a) => me(a)) ? t[o] = s : t[o] = Ni(i, s);
      return;
    }
    t[o] = i;
  }), t;
...
const Pi = class $e {
  ...
  leafNodesAndReturnIndex(e) {
    if (this.items.length === 0)
      return this.cursor;
    let t = this.cursor;
    return t === -1 ? t = e === $e.directions.RIGHT ? -1 : 0 : this.items[t].classList.remove(this.focusedCssClass), e === $e.directions.RIGHT ? t = (t + 1) % this.items.length : t = (this.items.length + t - 1) % this.items.length, h.canSetCaret(this.items[t]) && mt(() => k.setCursor(this.items[t]), 50)(), this.items[t].classList.add(this.focusedCssClass), t;
  }
};
Pi.directions = {
  RIGHT: "right",
...
class Se {
  ...
  constructor(e) {
    ...
    }, this.iterator = new Re(e.items, e.focusedItemClass), this.activateCallback = e.activateCallback, this.allowedKeys = e.allowedKeys || Se.usedKeys;
  }
  /**
   ...
   */
  handleEnterPress(e) {
    this.activated && (this.iterator.currentItem && (e.stopPropagation(), e.preventDefault(), this.iterator.currentItem.click()), P(this.activateCallback) && this.activateCallback(this.iterator.currentItem));
  }
  /**
...
const Wr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 12L9 7.1C9 7.04477 9.04477 7 9.1 7H10.4C11.5 7 14 7.1 14 9.5C14 9.5 14 12 11 12M9 12V16.8C9 16.9105 9.08954 17 9.2 17H12.5C14 17 15 16 15 14.5C15 11.7046 11 12 11 12M9 12H11"/></svg>', Kr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 10L11.8586 14.8586C11.9367 14.9367 12.0633 14.9367 12.1414 14.8586L17 10"/></svg>', Yr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.5 17.5L9.64142 12.6414C9.56331 12.5633 9.56331 12.4367 9.64142 12.3586L14.5 7.5"/></svg>', Vr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9.58284 17.5L14.4414 12.6414C14.5195 12.5633 14.5195 12.4367 14.4414 12.3586L9.58284 7.5"/></svg>', qr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 15L11.8586 10.1414C11.9367 10.0633 12.0633 10.0633 12.1414 10.1414L17 15"/></svg>', Xr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 8L12 12M12 12L16 16M12 12L16 8M12 12L8 16"/></svg>', Gr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/></svg>', Qr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M13.34 10C12.4223 12.7337 11 17 11 17"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.21 7H14.2"/></svg>', ii = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.69998 12.6L7.67896 12.62C6.53993 13.7048 6.52012 15.5155 7.63516 16.625V16.625C8.72293 17.7073 10.4799 17.7102 11.5712 16.6314L13.0263 15.193C14.0703 14.1609 14.2141 12.525 13.3662 11.3266L13.22 11.12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16.22 11.12L16.3564 10.9805C17.2895 10.0265 17.3478 8.5207 16.4914 7.49733V7.49733C15.5691 6.39509 13.9269 6.25143 12.8271 7.17675L11.3901 8.38588C10.0935 9.47674 9.95706 11.4241 11.0888 12.6852L11.12 12.72"/></svg>', Zr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 7.29999H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 7.29999H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.30999 12H9.3"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 12H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 16.7H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 16.7H14.59"/></svg>', Jr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 7V12M12 17V12M17 12H12M12 12H7"/></svg>', Di = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M11.5 17.5L5 11M5 11V15.5M5 11H9.5"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12.5 6.5L19 13M19 13V8.5M19 13H14.5"/></svg>', ea = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="10.5" cy="10.5" r="5.5" stroke="currentColor" stroke-width="2"/><line x1="15.4142" x2="19" y1="15" y2="18.5858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', ta = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M15.7795 11.5C15.7795 11.5 16.053 11.1962 16.5497 10.6722C17.4442 9.72856 17.4701 8.2475 16.5781 7.30145V7.30145C15.6482 6.31522 14.0873 6.29227 13.1288 7.25073L11.8796 8.49999"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8.24517 12.3883C8.24517 12.3883 7.97171 12.6922 7.47504 13.2161C6.58051 14.1598 6.55467 15.6408 7.44666 16.5869V16.5869C8.37653 17.5731 9.93744 17.5961 10.8959 16.6376L12.1452 15.3883"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M17.7802 15.1032L16.597 14.9422C16.0109 14.8624 15.4841 15.3059 15.4627 15.8969L15.4199 17.0818"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6.39064 9.03238L7.58432 9.06668C8.17551 9.08366 8.6522 8.58665 8.61056 7.99669L8.5271 6.81397"/><line x1="12.1142" x2="11.7" y1="12.2" y2="11.7858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', oa = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/><line x1="12" x2="12" y1="9" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 15.02V15.01"/></svg>', na = "__", ia = "--";
function Ee(n) {
  return (e, t) => [[n, e].filter((i) => !!i).join(na), t].filter((i) => !!i).join(ia);
}
const He = Ee("ce-hint"), je = {
  root: He(),
  alignedStart: He(null, "align-left"),
  alignedCenter: He(null, "align-center"),
  title: He("title"),
...
class sa {
  ...
  constructor(e) {
    this.nodes = {
      root: h.make("div", [je.root, e.alignment === "center" ? je.alignedCenter : je.alignedStart]),
      title: h.make("div", je.title, { textContent: e.title })
    }, this.nodes.root.appendChild(this.nodes.title), e.description !== void 0 && (this.nodes.description = h.make("div", je.description, { textContent: e.description }), this.nodes.root.appendChild(this.nodes.description));
  }
  /**
...
class Te extends Xo {
  ...
  constructor(e, t) {
    super(e), this.params = e, this.nodes = {
      ...
      var o;
      (o = this.nodes.root) == null || o.classList.remove(R.noFocus);
    }, this.removeSpecialHoverBehavior = () => {
      var o;
      (o = this.nodes.root) == null || o.classList.remove(R.noHover);
    }, this.onErrorAnimationEnd = () => {
      var o, i;
      (o = this.nodes.icon) == null || o.classList.remove(R.wobbleAnimation), (i = this.nodes.icon) == null || i.removeEventListener("animationend", this.onErrorAnimationEnd);
  ...
  make(e, t) {
    var s, r;
    const o = (t == null ? void 0 : t.wrapperTag) || "div", i = h.make(o, R.container, {
      type: o === "button" ? "button" : void 0
    });
    return e.name && (i.dataset.itemName = e.name), this.nodes.icon = h.make("div", [R.icon, R.iconTool], {
      innerHTML: e.icon || Gr
    }), i.appendChild(this.nodes.icon), e.title !== void 0 && i.appendChild(h.make("div", R.title, {
      innerHTML: e.title || ""
    })), e.secondaryLabel && i.appendChild(h.make("div", R.secondaryTitle, {
      textContent: e.secondaryLabel
    })), this.hasChildren && i.appendChild(h.make("div", [R.icon, R.iconChevronRight], {
      innerHTML: Vr
    })), this.isActive && i.classList.add(R.active), e.isDisabled && i.classList.add(R.disabled), e.hint !== void 0 && ((s = t == null ? void 0 : t.hint) == null ? void 0 : s.enabled) !== !1 && this.addHint(i, {
      ...e.hint,
  ...
  enableConfirmationMode(e) {
    ...
    this.nodes.root.innerHTML = o.innerHTML, this.nodes.root.classList.add(R.confirmationState), this.confirmationState = e, this.enableSpecialHoverAndFocusBehavior();
  }
  /**
  ...
  enableSpecialHoverAndFocusBehavior() {
    var e, t, o;
    (e = this.nodes.root) == null || e.classList.add(R.noHover), (t = this.nodes.root) == null || t.classList.add(R.noFocus), (o = this.nodes.root) == null || o.addEventListener("mouseleave", this.removeSpecialHoverBehavior, { once: !0 });
  }
  /**
  ...
  animateError() {
    var e, t, o;
    (e = this.nodes.icon) != null && e.classList.contains(R.wobbleAnimation) || ((t = this.nodes.icon) == null || t.classList.add(R.wobbleAnimation), (o = this.nodes.icon) == null || o.addEventListener("animationend", this.onErrorAnimationEnd));
  }
}
const po = Ee("ce-popover-item-separator"), fo = {
  container: po(),
  line: po("line"),
  hidden: po(null, "hidden")
};
class Ri extends Xo {
  /**
   * Constructs the instance
  ...
  constructor() {
    super(), this.nodes = {
      root: h.make("div", fo.container),
      line: h.make("div", fo.line)
  ...
  toggleHidden(e) {
    var t;
    (t = this.nodes.root) == null || t.classList.toggle(fo.hidden, e);
  }
}
var de = /* @__PURE__ */ ((n) => (n.Closed = "closed", n.ClosedOnActivate = "closed-on-activate", n))(de || {});
const q = Ee("ce-popover"), j = {
  popover: q(),
  popoverContainer: q("container"),
  popoverOpenTop: q(null, "open-top"),
  popoverOpenLeft: q(null, "open-left"),
  popoverOpened: q(null, "opened"),
  search: q("search"),
  nothingFoundMessage: q("nothing-found-message"),
  nothingFoundMessageDisplayed: q("nothing-found-message", "displayed"),
  items: q("items"),
  overlay: q("overlay"),
  overlayHidden: q("overlay", "hidden"),
  popoverNested: q(null, "nested"),
  getPopoverNestedClass: (n) => q(null, `nested-level-${n.toString()}`),
  popoverInline: q(null, "inline"),
  popoverHeader: q("header")
};
var Me = /* @__PURE__ */ ((n) => (n.NestingLevel = "--nesting-level", n.PopoverHeight = "--popover-height", n.InlinePopoverWidth = "--inline-popover-width", n.TriggerItemLeft = "--trigger-item-left", n.TriggerItemTop = "--trigger-item-top", n))(Me || {});
const si = Ee("ce-popover-item-html"), ri = {
  root: si(),
  hidden: si(null, "hidden")
};
class Je extends Xo {
  /**
   * Constructs the instance
  ...
  toggleHidden(e) {
    var t;
    (t = this.nodes.root) == null || t.classList.toggle(ri.hidden, e);
  }
  /**
...
class Hi extends nt {
   ...
   */
  constructor(e, t = {}) {
    super(), this.params = e, this.itemsRenderParams = t, this.listeners = new it(), this.messages = {
      nothingFound: "Nothing found",
      search: "Search"
    }, this.items = this.buildItems(e.items), e.messages && (this.messages = {
      ...this.messages,
      ...e.messages
    }), this.nodes = {}, this.nodes.popoverContainer = h.make("div", [j.popoverContainer]), this.nodes.nothingFoundMessage = h.make("div", [j.nothingFoundMessage], {
      textContent: this.messages.nothingFound
    }), this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage), this.nodes.items = h.make("div", [j.items]), this.items.forEach((o) => {
   ...
   */
  get itemsDefault() {
    return this.items.filter((e) => e instanceof Te);
  }
  /**
   ...
   */
  show() {
    this.nodes.popover.classList.add(j.popoverOpened), this.search !== void 0 && this.search.focus();
  }
  /**
   * Closes popover
   */
  hide() {
    this.nodes.popover.classList.remove(j.popoverOpened), this.nodes.popover.classList.remove(j.popoverOpenTop), this.itemsDefault.forEach((e) => e.reset()), this.search !== void 0 && this.search.clear(), this.emit(de.Closed);
  }
  /**
   * Clears memory
   */
    ...
    return e.map((t) => {
      switch (t.type) {
        case N.Separator:
          return new Ri();
        case N.Html:
          return new Je(t, this.itemsRenderParams[N.Html]);
        default:
          return new Te(t, this.itemsRenderParams[N.Default]);
      }
    });
  }
  /**
   ...
   */
  getTargetItem(e) {
    return this.items.filter((t) => t instanceof Te || t instanceof Je).find((t) => {
  ...
  toggleItemActivenessIfNeeded(e) {
    if (e instanceof Te && (e.toggle === !0 && e.toggleActive(), typeof e.toggle == "string")) {
...
var wt = /* @__PURE__ */ ((n) => (n.Search = "search", n))(wt || {});
const go = Ee("cdx-search-field"), mo = {
  wrapper: go(),
  icon: go("icon"),
  input: go("input")
};
class ra extends nt {
  ...
  constructor({ items: e, placeholder: t }) {
    super(), this.listeners = new it(), this.items = e, this.wrapper = h.make("div", mo.wrapper);
    const o = h.make("div", mo.icon, {
      innerHTML: ea
    });
    this.input = h.make("input", mo.input, {
      placeholder: t,
      /**
      ...
      this.searchQuery = this.input.value, this.emit(wt.Search, {
   ...
   */
  clear() {
    this.input.value = "", this.searchQuery = "", this.emit(wt.Search, {
      query: "",
      items: this.foundItems
    });
  }
...
var aa = Object.defineProperty, la = Object.getOwnPropertyDescriptor, ca = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? la(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && aa(e, t, i), i;
};
const ji = class Fi extends Hi {
  /**
  ...
  constructor(e, t) {
    super(e, t), this.nestingLevel = 0, this.nestedPopoverTriggerItem = null, this.previouslyHoveredItem = null, this.scopeElement = document.body, this.hide = () => {
      ...
      this.items.forEach((l) => {
        let c = !1;
        l instanceof Te ? c = !o.items.includes(l) : (l instanceof Ri || l instanceof Je) && (c = s || !i), l.toggleHidden(c);
    ...
    }, e.nestingLevel !== void 0 && (this.nestingLevel = e.nestingLevel), this.nestingLevel > 0 && this.nodes.popover.classList.add(j.popoverNested), e.scopeElement !== void 0 && (this.scopeElement = e.scopeElement), this.nodes.popoverContainer !== null && this.listeners.on(this.nodes.popoverContainer, "mouseover", (o) => this.handleHover(o)), e.searchable && this.addSearch(), e.flippable !== !1 && (this.flipper = new Se({
  ...
  show() {
    var e;
    this.nodes.popover.style.setProperty(Me.PopoverHeight, this.size.height + "px"), this.shouldOpenBottom || this.nodes.popover.classList.add(j.popoverOpenTop), this.shouldOpenRight || this.nodes.popover.classList.add(j.popoverOpenLeft), super.show(), (e = this.flipper) == null || e.activate(this.flippableElements);
  }
  /**
   * Clears memory
   */
  ...
  get size() {
    ...
    t.style.visibility = "hidden", t.style.position = "absolute", t.style.top = "-1000px", t.classList.add(j.popoverOpened), (i = t.querySelector("." + j.popoverNested)) == null || i.remove(), document.body.appendChild(t);
    const o = t.querySelector("." + j.popoverContainer);
  ...
  addSearch() {
    ...
    }), this.search.on(wt.Search, this.onSearch);
    const e = this.search.getElement();
    e.classList.add(j.search), this.nodes.popoverContainer.insertBefore(e, this.nodes.popoverContainer.firstChild);
  }
  /**
  ...
  toggleNothingFoundMessage(e) {
    this.nodes.nothingFoundMessage.classList.toggle(j.nothingFoundMessageDisplayed, e);
  }
};
ca([
  Pe
...
class da extends Go {
  ...
  constructor(e) {
    ...
    super(
      ...
      !(o instanceof Te) && !(o instanceof Je) || o.hasChildren && o.isChildrenOpen && this.showNestedItems(o);
    });
  }
  /**
   * Returns visible element offset top
  ...
  showNestedPopoverForItem(e) {
    ...
    return t.getElement().classList.add(j.getPopoverNestedClass(t.nestingLevel)), t;
  }
  /**
...
const $i = class Ue {
   ...
   */
  lock() {
    Oo ? this.lockHard() : document.body.classList.add(Ue.CSS.scrollLocked);
  }
  /**
   * Unlocks body element scroll
   */
  unlock() {
    Oo ? this.unlockHard() : document.body.classList.remove(Ue.CSS.scrollLocked);
  }
  /**
...
let ua = $i;
const bo = Ee("ce-popover-header"), vo = {
  root: bo(),
  text: bo("text"),
  backButton: bo("back-button")
};
class ha {
  /**
   * Constructs the instance
  ...
  constructor({ text: e, onBackButtonClick: t }) {
    this.listeners = new it(), this.text = e, this.onBackButtonClick = t, this.nodes = {
      root: h.make("div", [vo.root]),
      backButton: h.make("button", [vo.backButton]),
      text: h.make("div", [vo.text])
    }, this.nodes.backButton.innerHTML = Yr, this.nodes.root.appendChild(this.nodes.backButton), this.listeners.on(this.nodes.backButton, "click", this.onBackButtonClick), this.nodes.text.innerText = this.text, this.nodes.root.appendChild(this.nodes.text);
  }
  /**
...
class Ui extends Hi {
  ...
  constructor(e) {
    ...
    }), this.scrollLocker = new ua(), this.history = new pa(), this.isHidden = !0, this.nodes.overlay = h.make("div", [j.overlay, j.overlayHidden]), this.nodes.popover.insertBefore(this.nodes.overlay, this.nodes.popover.firstChild), this.listeners.on(this.nodes.overlay, "click", () => {
      this.hide();
   ...
   */
  show() {
    this.nodes.overlay.classList.remove(j.overlayHidden), super.show(), this.scrollLocker.lock(), this.isHidden = !1;
  }
  /**
   * Closes popover
   */
  hide() {
    this.isHidden || (super.hide(), this.nodes.overlay.classList.add(j.overlayHidden), this.scrollLocker.unlock(), this.history.reset(), this.isHidden = !0);
  }
  /**
   * Clears memory
   */
...
class fa extends I {
  constructor() {
    super(...arguments), this.opened = !1, this.hasMobileLayoutToggleListener = !1, this.selection = new k(), this.popover = null, this.close = () => {
   ...
   */
  make() {
    this.nodes.wrapper = h.make("div", [this.CSS.settings]), this.eventsDispatcher.on(Ze, this.close), this.hasMobileLayoutToggleListener = !0;
  }
  /**
   * Destroys module
   */
  ...
  async open(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.popover = new i({
      ...
      messages: {
        nothingFound: X.ui(J.ui.popover, "Nothing found"),
        search: X.ui(J.ui.popover, "Filter")
      }
    }), this.popover.on(de.Closed, this.onPopoverClose), (s = this.nodes.wrapper) == null || s.append(this.popover.getElement()), this.popover.show();
  }
  /**
  ...
  async getTunesItems(e, t, o) {
    ...
    const s = Array.from(this.Editor.Tools.blockTools.values()), a = (await Ai(e, s)).reduce((l, c) => (c.toolbox.forEach((d) => {
      l.push({
        icon: d.icon,
        title: X.t(J.toolNames, d.title),
        name: c.name,
        closeOnActivate: !0,
        onActivate: async () => {
          const { BlockManager: u, Caret: p, Toolbar: m } = this.Editor, f = await u.convert(e, c.name, d.data);
          m.close(), p.setToBlock(f, p.positions.END);
        }
      });
    }), l), []);
    return a.length > 0 && (i.push({
      icon: Di,
      name: "convert-to",
      title: X.ui(J.ui.popover, "Convert to"),
      children: {
        searchable: !0,
        items: a
      }
  ...
  resolveTuneAliases(e) {
    if (e.type === N.Separator || e.type === N.Html)
      return e;
...
const Ne = new ba();
var va = Object.defineProperty, ka = Object.getOwnPropertyDescriptor, Wi = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? ka(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && va(e, t, i), i;
}, dt = /* @__PURE__ */ ((n) => (n.Opened = "toolbox-opened", n.Closed = "toolbox-closed", n.BlockAdded = "toolbox-block-added", n))(dt || {});
const Qo = class Ki extends nt {
  /**
   * Toolbox constructor
   *
  ...
  constructor({ api: e, tools: t, i18nLabels: o }) {
    super(), this.opened = !1, this.listeners = new it(), this.popover = null, this.handleMobileLayoutToggle = () => {
      ...
      toolbox: h.make("div", Ki.CSS.toolbox)
  ...
  destroy() {
    var e;
    super.destroy(), this.nodes && this.nodes.toolbox && this.nodes.toolbox.remove(), this.removeAllShortcuts(), (e = this.popover) == null || e.off(de.Closed, this.onPopoverClose), this.listeners.destroy(), this.api.events.off(Ze, this.handleMobileLayoutToggle);
  }
  /**
  ...
  initPopover() {
    ...
    }), this.popover.on(de.Closed, this.onPopoverClose), (t = this.nodes.toolbox) == null || t.append(this.popover.getElement());
  }
  /**
  ...
  get toolboxItemsToBeDisplayed() {
    const e = (t, o, i = !0) => ({
      icon: t.icon,
      title: X.t(J.toolNames, t.title || bt(o.name)),
      name: o.name,
      onActivate: () => {
        this.toolButtonActivated(o.name, t.data);
      },
      secondaryLabel: o.shortcut && i ? Wo(o.shortcut) : ""
    });
  ...
  async insertNewBlock(e, t) {
    ...
    a.call(ge.APPEND_CALLBACK), this.api.caret.setToBlock(s), this.emit("toolbox-block-added", {
      block: a
...
Wi([
  Pe
], Qo.prototype, "toolsToBeDisplayed", 1);
Wi([
  Pe
], Qo.prototype, "toolboxItemsToBeDisplayed", 1);
let ya = Qo;
const Yi = "block hovered";
...
class wa extends I {
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    ...
    if (o)
      ...
      const u = sr(r), p = parseInt(window.getComputedStyle(this.nodes.plusButton).height, 10), m = 8;
      i = t.offsetTop + u - p + m + c;
    }
   ...
   */
  async make() {
    this.nodes.wrapper = h.make("div", this.CSS.toolbar), ["content", "actions"].forEach((s) => {
      this.nodes[s] = h.make("div", this.CSS[s]);
      ...
      yt(!0), this.plusButtonClicked();
    }, !1);
    const e = h.make("div");
    e.appendChild(document.createTextNode(X.ui(J.ui.toolbar.toolbox, "Add"))), e.appendChild(h.make("div", this.CSS.plusButtonShortcut, {
      textContent: "/"
    })), Et(this.nodes.plusButton, e, {
      hidingDelay: 400
    }), this.nodes.settingsToggler = h.make("span", this.CSS.settingsToggler, {
      innerHTML: Zr
    }), h.append(this.nodes.actions, this.nodes.settingsToggler);
    const t = h.make("div"), o = h.text(X.ui(J.ui.blockTunes.toggler, "Click to tune")), i = await Ea("Slash", "/");
    t.appendChild(o), t.appendChild(h.make("div", this.CSS.plusButtonShortcut, {
      textContent: Wo(`CMD + ${i}`)
    })), Et(this.nodes.settingsToggler, t, {
      hidingDelay: 400
  ...
  makeToolbox() {
    return this.toolboxInstance = new ya({
      ...
      i18nLabels: {
        filter: X.ui(J.ui.popover, "Filter"),
        nothingFound: X.ui(J.ui.popover, "Nothing found")
      }
    }), this.toolboxInstance.on(dt.Opened, () => {
      this.Editor.UI.nodes.wrapper.classList.add(this.CSS.openedToolboxHolderModifier);
    }), this.toolboxInstance.on(dt.Closed, () => {
      this.Editor.UI.nodes.wrapper.classList.remove(this.CSS.openedToolboxHolderModifier);
    }), this.toolboxInstance.on(dt.BlockAdded, ({ block: e }) => {
  ...
  enableModuleBindings() {
    this.readOnlyMutableListeners.on(this.nodes.settingsToggler, "mousedown", (e) => {
      var t;
      e.stopPropagation(), this.settingsTogglerClicked(), (t = this.toolboxInstance) != null && t.opened && this.toolboxInstance.close(), yt(!0);
    }, !0), De() || this.eventsDispatcher.on(Yi, (e) => {
      var t;
...
var Ce = /* @__PURE__ */ ((n) => (n[n.Block = 0] = "Block", n[n.Inline = 1] = "Inline", n[n.Tune = 2] = "Tune", n))(Ce || {}), ut = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.Toolbox = "toolbox", n.EnabledInlineTools = "inlineToolbar", n.EnabledBlockTunes = "tunes", n.Config = "config", n))(ut || {}), Vi = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.SanitizeConfig = "sanitize", n))(Vi || {}), Le = /* @__PURE__ */ ((n) => (n.IsEnabledLineBreaks = "enableLineBreaks", n.Toolbox = "toolbox", n.ConversionConfig = "conversionConfig", n.IsReadOnlySupported = "isReadOnlySupported", n.PasteConfig = "pasteConfig", n))(Le || {}), Tt = /* @__PURE__ */ ((n) => (n.IsInline = "isInline", n.Title = "title", n.IsReadOnlySupported = "isReadOnlySupported", n))(Tt || {}), _o = /* @__PURE__ */ ((n) => (n.IsTune = "isTune", n))(_o || {});
class Zo {
  /**
   * @class
   ...
   */
  prepare() {
    if (P(this.constructable.prepare))
...
class Ta extends I {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    ...
    }, this.opened = !1, this.popover = null, this.toolbarVerticalMargin = De() ? 20 : 6, this.tools = /* @__PURE__ */ new Map(), window.requestIdleCallback(() => {
      this.make();
    }, { timeout: 2e3 });
  }
  /**
  ...
  close() {
    ...
    if (this.opened) {
      for (const [o, i] of this.tools) {
        ...
        s !== void 0 && Ne.remove(this.Editor.UI.nodes.redactor, s), P(i.clear) && i.clear();
      }
  ...
  async getPopoverItems() {
    ...
    for (const [o, i] of this.tools) {
      ...
      const a = r !== void 0 ? Wo(r) : void 0, l = X.t(
        J.toolNames,
        o.title || bt(o.name)
      );
      [s].flat().forEach((c) => {
        ...
        if (h.isElement(c)) {
          ...
          if (P(i.renderActions)) {
            const f = i.renderActions();
            m.children = {
              isOpen: (u = i.checkState) == null ? void 0 : u.call(i, k.get()),
            ...
            (p = i.checkState) == null || p.call(i, k.get());
          e.push(m);
        } else if (c.type === N.Html)
          e.push({
            ...d,
            ...c,
            type: N.Html
          });
        else if (c.type === N.Separator)
          e.push({
            type: N.Separator
          });
        else {
          ...
          "children" in m && t !== 0 && e.push({
            type: N.Separator
          }), e.push(m), "children" in m && t < this.tools.size - 1 && e.push({
            type: N.Separator
          });
        }
      }), t++;
  ...
  getToolShortcut(e) {
    ...
    return Array.from(i.keys()).includes(e) ? this.inlineTools[e][Vi.Shortcut] : o == null ? void 0 : o.shortcut;
  }
  /**
...
var Gi = {}, Jo = {}, eo = {}, Ie = {}, en = {}, tn = {};
Object.defineProperty(tn, "__esModule", { value: !0 });
tn.allInputsSelector = xa;
function xa() {
...
const Pa = () => typeof window < "u" && window.navigator !== null && hn(window.navigator.platform) && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1);
function Da(n) {
  const e = es();
  return n = n.replace(/shift/gi, "⇧").replace(/backspace/gi, "⌫").replace(/enter/gi, "⏎").replace(/up/gi, "↑").replace(/left/gi, "→").replace(/down/gi, "↓").replace(/right/gi, "←").replace(/escape/gi, "⎋").replace(/insert/gi, "Ins").replace(/delete/gi, "␡").replace(/\+/gi, "+"), e.mac ? n = n.replace(/ctrl|cmd/gi, "⌘").replace(/alt/gi, "⌥") : n = n.replace(/cmd/gi, "Ctrl").replace(/windows/gi, "WIN"), n;
}
...
function $a(n) {
  return ts(n) && /^\s*class\s+/.test(n.toString());
}
function Ua(n) {
  return ye(n) === "number";
}
...
function Mo(n, ...e) {
  ...
  if (ft(n) && ft(t))
    for (const o in t)
      ft(t[o]) ? (n[o] === void 0 && Object.assign(n, { [o]: {} }), Mo(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
  return Mo(n, ...e);
}
function Ya(n, e, t) {
  const o = `«${e}» is deprecated and will be removed in the next major release. Please use the «${t}» instead.`;
...
const Ja = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  cacheable: Ma,
  capitalize: Ra,
  copyTextToClipboard: Ha,
  debounce: ja,
  deepMerge: Mo,
  deprecationAssert: Ya,
  getUserOS: es,
  getValidUrl: Va,
  isBoolean: Fa,
  isClass: $a,
  ...
  throttle: Za,
  typeOf: ye
}, Symbol.toStringTag, { value: "Module" })), pn = /* @__PURE__ */ Ws(Ja);
Object.defineProperty(un, "__esModule", { value: !0 });
un.containsOnlyInlineElements = ol;
var el = pn, tl = sn;
function ol(n) {
  var e;
  (0, el.isString)(n) ? (e = document.createElement("div"), e.innerHTML = n) : e = n;
  var t = function(o) {
    return !(0, tl.blockElements)().includes(o.tagName.toLowerCase()) && Array.from(o.children).every(t);
  };
...
mn.getContentLength = al;
var rl = Oe;
function al(n) {
  var e, t;
  return (0, rl.isNativeInput)(n) ? n.value.length : n.nodeType === Node.TEXT_NODE ? n.length : (t = (e = n.textContent) === null || e === void 0 ? void 0 : e.length) !== null && t !== void 0 ? t : 0;
}
(function(n) {
...
var bn = {}, vn = {}, ai = Qe && Qe.__spreadArray || function(n, e, t) {
...
vn.getDeepestBlockElements = is;
var ll = to;
function is(n) {
  return (0, ll.containsOnlyInlineElements)(n) ? [n] : Array.from(n.children).reduce(function(e, t) {
    return ai(ai([], e, !0), is(t), !0);
  }, []);
}
(function(n) {
...
kn.getDeepestNode = rs;
var ul = Oe, hl = no, pl = io;
function rs(n, e) {
  e === void 0 && (e = !1);
  var t = e ? "lastChild" : "firstChild", o = e ? "previousSibling" : "nextSibling";
  if (n.nodeType === Node.ELEMENT_NODE && n[t]) {
    var i = n[t];
    if ((0, pl.isSingleTag)(i) && !(0, ul.isNativeInput)(i) && !(0, hl.isLineBreakTag)(i))
      if (i[o])
        i = i[o];
...
var as = {}, wn = {}, st = Qe && Qe.__spreadArray || function(n, e, t) {
  if (t || arguments.length === 2)
    for (var o = 0, i = e.length, s; o < i; o++)
      (s || !(o in e)) && (s || (s = Array.prototype.slice.call(e, 0, o)), s[o] = e[o]);
  return n.concat(s || Array.prototype.slice.call(e));
...
wn.findAllInputs = vl;
var fl = to, gl = bn, ml = en, bl = Oe;
function vl(n) {
  return Array.from(n.querySelectorAll((0, ml.allInputsSelector)())).reduce(function(e, t) {
    return (0, bl.isNativeInput)(t) || (0, fl.containsOnlyInlineElements)(t) ? st(st([], e, !0), [t], !1) : st(st([], e, !0), (0, gl.getDeepestBlockElements)(t), !0);
  }, []);
}
(function(n) {
...
var yl = pn;
function El(n) {
  return (0, yl.isNumber)(n) ? !1 : !!n && !!n.nodeType && n.nodeType === Node.ELEMENT_NODE;
}
(function(n) {
...
Object.defineProperty(An, "__esModule", { value: !0 });
An.isNodeEmpty = Sl;
var Tl = no, xl = xn, Cl = Oe, Bl = io;
function Sl(n, e) {
  var t = "";
  return (0, Bl.isSingleTag)(n) && !(0, Tl.isLineBreakTag)(n) ? !1 : ((0, xl.isElement)(n) && (0, Cl.isNativeInput)(n) ? t = n.value : n.textContent !== null && (t = n.textContent.replace("​", "")), e !== void 0 && (t = t.replace(new RegExp(e, "g"), "")), t.trim().length === 0);
}
(function(n) {
...
function Al(n, e) {
  ...
  for (var t = [n]; t.length > 0; ) {
    var o = t.shift();
    if (o) {
      if (n = o, (0, Il.isLeaf)(n) && !(0, Ol.isNodeEmpty)(n, e))
        return !1;
...
var Ll = pn;
function _l(n) {
  return (0, Ll.isNumber)(n) ? !1 : !!n && !!n.nodeType && n.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
}
(function(n) {
...
eo.checkContenteditableSliceForEmptiness = $l;
var jl = Ie, Fl = so;
function $l(n, e, t, o) {
  var i = (0, Fl.getContenteditableSlice)(n, e, t, o);
  return (0, jl.isCollapsedWhitespaces)(i);
}
(function(n) {
...
function zl(n, e) {
  var t, o;
  if (e === void 0 && (e = !0), (0, Ul.isNativeInput)(n)) {
    n.focus();
    ...
    var a = function(p) {
      ...
      p.appendChild(m), s.setStart(m, 0), s.setEnd(m, 0);
    }, l = function(p) {
      return p != null;
...
var bs = {}, Rn = {};
Object.defineProperty(Rn, "__esModule", { value: !0 });
Rn.isCaretAtEndOfInput = ql;
var li = Ie, Yl = Dn, Vl = Jo;
function ql(n) {
  var e = (0, li.getDeepestNode)(n, !0);
  if (e === null)
    return !0;
  if ((0, li.isNativeInput)(e))
    return e.selectionEnd === e.value.length;
  var t = (0, Yl.getCaretNodeAndOffset)(), o = t[0], i = t[1];
  return o === null ? !1 : (0, Vl.checkContenteditableSliceForEmptiness)(n, o, i, "right");
}
(function(n) {
...
Hn.isCaretAtStartOfInput = Ql;
var rt = Ie, Xl = ro, Gl = eo;
function Ql(n) {
  var e = (0, rt.getDeepestNode)(n);
  if (e === null || (0, rt.isEmpty)(n))
    return !0;
  if ((0, rt.isNativeInput)(e))
    return e.selectionEnd === 0;
  if ((0, rt.isEmpty)(n))
    return !0;
  var t = (0, Xl.getCaretNodeAndOffset)(), o = t[0], i = t[1];
  return o === null ? !1 : (0, Gl.checkContenteditableSliceForEmptiness)(n, o, i, "left");
}
(function(n) {
...
var Zl = Ie, Jl = ao;
function ec() {
  var n = (0, Jl.getRange)(), e = (0, Zl.make)("span");
...
class tc extends I {
  ...
  beforeKeydownProcessing(e) {
    this.needToolbarClosing(e) && yi(e.keyCode) && (this.Editor.Toolbar.close(), e.ctrlKey || e.metaKey || e.altKey || e.shiftKey || this.Editor.BlockSelection.clearSelection(e));
  }
  /**
   * Key up on Block:
  ...
  enter(e) {
    ...
    if (i === void 0 || i.tool.isLineBreaksEnabled || o.someToolbarOpened && o.someFlipperButtonFocused || e.shiftKey && !Oo)
      return;
    let s = i;
    i.currentInput !== void 0 && ht(i.currentInput) && !i.hasMedia ? this.Editor.BlockManager.insertDefaultBlockAtIndex(this.Editor.BlockManager.currentBlockIndex) : i.currentInput && pt(i.currentInput) ? s = this.Editor.BlockManager.insertDefaultBlockAtIndex(this.Editor.BlockManager.currentBlockIndex + 1) : s = this.Editor.BlockManager.split(), this.Editor.Caret.setToBlock(s), this.Editor.Toolbar.moveAndOpen(s), e.preventDefault();
  }
  /**
  ...
  backspace(e) {
    ...
    if (i === void 0 || !k.isCollapsed || !i.currentInput || !ht(i.currentInput))
      return;
    ...
    oi(s, i) ? this.mergeBlocks(s, i) : o.setToBlock(s, o.positions.END);
  }
  /**
  ...
  delete(e) {
    ...
    if (!k.isCollapsed || !pt(i.currentInput))
      return;
    ...
    oi(i, s) ? this.mergeBlocks(i, s) : o.setToBlock(s, o.positions.START);
  }
  /**
   * Merge passed Blocks
   *
  ...
  arrowRightAndDown(e) {
    ...
    if (this.Editor.UI.someToolbarOpened && t)
      return;
    this.Editor.Toolbar.close();
    const { currentBlock: o } = this.Editor.BlockManager, s = ((o == null ? void 0 : o.currentInput) !== void 0 ? pt(o.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (Se.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === w.TAB))
        return;
      this.Editor.UI.closeAllToolbars();
    }
    this.Editor.Toolbar.close();
    const { currentBlock: t } = this.Editor.BlockManager, i = ((t == null ? void 0 : t.currentInput) !== void 0 ? ht(t.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
...
class ko {
  ...
  insert(e, t, o = !1) {
    ...
    e > this.length && (e = this.length), o && (this.blocks[e].holder.remove(), this.blocks[e].call(ge.REMOVED));
    const i = o ? 1 : 0;
  ...
  insertMany(e, t) {
    ...
    e.forEach((i) => i.call(ge.RENDERED));
  }
  /**
   * Remove block
   *
   ...
   */
  remove(e) {
    isNaN(e) && (e = this.length - 1), this.blocks[e].holder.remove(), this.blocks[e].call(ge.REMOVED), this.blocks.splice(e, 1);
  }
  /**
   * Remove all blocks
   */
  removeAll() {
    this.workingArea.innerHTML = "", this.blocks.forEach((e) => e.call(ge.REMOVED)), this.blocks.length = 0;
  }
  /**
   ...
   */
  insertToDOM(e, t, o) {
    t ? o.holder.insertAdjacentElement(t, e.holder) : this.workingArea.appendChild(e.holder), e.call(ge.RENDERED);
  }
  /**
...
const ci = "block-removed", di = "block-added", oc = "block-moved", ui = "block-changed";
class nc {
  constructor() {
    this.completed = Promise.resolve();
  }
...
class ic extends I {
   ...
   */
  prepare() {
    const e = new ko(this.Editor.UI.nodes.redactor);
  ...
  composeBlock({
    ...
    const s = this.Editor.ReadOnly.isEnabled, r = this.Editor.Tools.blockTools.get(e), a = new U({
      id: o,
      data: t,
      tool: r,
      api: this.Editor.API,
  ...
  insert({
    ...
    return r && this.blockDidMutated(ci, this.getBlockByIndex(l), {
      index: l
    }), this._blocks.insert(l, c, r), this.blockDidMutated(di, c, {
      index: l
  ...
  async update(e, t, o) {
    ...
    return this._blocks.replace(r, s), this.blockDidMutated(ui, s, {
      index: r
    }), s;
  }
  /**
  ...
  paste(e, t, o = !1) {
    ...
    try {
      window.requestIdleCallback(() => {
        i.call(ge.ON_PASTE, t);
      });
    } catch (s) {
      M(`${e}: onPaste callback call is failed`, "error", s);
    }
    return i;
  }
  /**
  ...
  insertDefaultBlockAtIndex(e, t = !1) {
    ...
    return this._blocks[e] = o, this.blockDidMutated(di, o, {
      index: e
  ...
  async mergeBlocks(e, t) {
    ...
    if (e.name === t.name && e.mergeable) {
      ...
      const [s] = Yo([i], e.tool.sanitizeConfig);
      o = s;
    } else if (e.mergeable && kt(t, "export") && kt(e, "import")) {
      const i = await t.exportDataAsString(), s = ce(i, e.tool.sanitizeConfig);
      o = ni(s, e.tool.conversionConfig);
    }
  ...
  removeBlock(e, t = !0) {
    return new Promise((o) => {
      ...
      this._blocks.remove(i), e.destroy(), this.blockDidMutated(ci, e, {
        index: i
  ...
  getBlock(e) {
    ...
    const t = this._blocks.nodes, o = e.closest(`.${U.CSS.wrapper}`), i = t.indexOf(o);
    if (i >= 0)
  ...
  setCurrentBlockByChildNode(e) {
    h.isElement(e) || (e = e.parentNode);
    const t = e.closest(`.${U.CSS.wrapper}`);
    if (!t)
      return;
  ...
  move(e, t = this.currentBlockIndex) {
    ...
    this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(oc, this.currentBlock, {
      fromIndex: t,
      toIndex: e
    });
  }
  ...
  async convert(e, t, o) {
    ...
    const r = await e.exportDataAsString(), a = ce(
      r,
      s.sanitizeConfig
    );
    let l = ni(a, s.conversionConfig, s.settings);
  ...
  bindBlockEvents(e) {
    ...
    this.readOnlyMutableListeners.on(e.holder, "keydown", (o) => {
      ...
      t.dragLeave(o);
    }), e.on("didMutated", (o) => this.blockDidMutated(ui, o, {
  ...
  blockDidMutated(e, t, o) {
    ...
    return this.eventsDispatcher.emit(vt, {
      event: i
    }), t;
  }
}
class sc extends I {
  ...
  clearSelection(e, t = !1) {
    ...
    const r = e && e instanceof KeyboardEvent, a = r && yi(e.keyCode);
    if (this.anyBlockSelected && r && a && !k.isSelectionExists) {
      const l = o.removeSelectedBlocks();
      o.insertDefaultBlockAtIndex(l, !0), i.setToBlock(o.currentBlock), mt(() => {
        const c = e.key;
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((s) => {
      const r = ce(s.holder.innerHTML, this.sanitizerConfig), a = h.make("p");
...
class xt extends I {
   ...
   */
  set(e, t = 0) {
    const { top: i, bottom: s } = k.setCursor(e, t), { innerHeight: r } = window;
  ...
  navigateNext(e = !1) {
    ...
    if (o === void 0)
      return !1;
    const { nextInput: s, currentInput: r } = o, a = r !== void 0 ? pt(r) : void 0;
    let l = i;
  ...
  navigatePrevious(e = !1) {
    ...
    if (!t)
      return !1;
    const { previousInput: i, currentInput: s } = t, r = s !== void 0 ? ht(s) : void 0, a = e || r || !t.focusable;
  ...
  createShadow(e) {
    ...
    t.classList.add(xt.CSS.shadowCaret), e.insertAdjacentElement("beforeend", t);
  }
  /**
   ...
   */
  restoreCaret(e) {
    const t = e.querySelector(`.${xt.CSS.shadowCaret}`);
    if (!t)
      return;
    new k().expandToTag(t);
    const i = document.createRange();
  ...
  insertContentAtCaretPosition(e) {
    const t = document.createDocumentFragment(), o = document.createElement("div"), i = k.get(), s = k.range;
    ...
    super(...arguments), this.onMouseUp = () => {
      ...
      if (!(!i || !s) && s !== i) {
        if (i === this.firstSelectedBlock) {
          k.get().removeAllRanges(), i.selected = !0, s.selected = !0, o.clearCache();
          return;
        }
...
class dc extends I {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    super({
      config: e,
      eventsDispatcher: t
    }), this.disabled = !1, this.batchingTimeout = null, this.batchingOnChangeQueue = /* @__PURE__ */ new Map(), this.batchTime = cc, this.mutationObserver = new MutationObserver((o) => {
      this.redactorChanged(o);
    }), this.eventsDispatcher.on(vt, (o) => {
  ...
  particularBlockChanged(e) {
    this.disabled || !P(this.config.onChange) || (this.batchingOnChangeQueue.set(`block:${e.detail.target.id}:event:${e.type}`, e), this.batchingTimeout && clearTimeout(this.batchingTimeout), this.batchingTimeout = setTimeout(() => {
      let t;
   ...
   */
  redactorChanged(e) {
    this.eventsDispatcher.emit(Ao, {
      mutations: e
    });
  }
}
const uc = "ö", hc = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", No = "numeric", Po = "ascii", Do = "alpha", We = "asciinumeric", ze = "alphanumeric", Ro = "domain", ys = "emoji", pc = "scheme", fc = "slashscheme", yo = "whitespace";
function gc(n, e) {
  return n in e || (e[n] = []), e[n];
}
function xe(n, e, t) {
  e[No] && (e[We] = !0, e[ze] = !0), e[Po] && (e[We] = !0, e[Do] = !0), e[We] && (e[ze] = !0), e[Do] && (e[ze] = !0), e[ze] && (e[Ro] = !0), e[ys] && (e[Ro] = !0);
  for (const o in e) {
    const i = gc(o, t);
...
Z.prototype = {
  ...
  tr(n, e, t, o) {
    o = o || Z.groups;
    let i;
    return e && e.j ? i = e : (i = new Z(e), t && o && xe(e, t, o)), this.jr.push([n, i]), i;
  },
  /**
  ...
  tt(n, e, t, o) {
    ...
    const s = e;
    let r, a = i.go(n);
    if (a ? (r = new Z(), Object.assign(r.j, a.j), r.jr.push.apply(r.jr, a.jr), r.jd = a.jd, r.t = a.t) : r = new Z(), s) {
      if (o)
        if (r.t && typeof r.t == "string") {
          const l = Object.assign(mc(r.t, o), t);
          xe(s, l, o);
        } else
          t && xe(s, t, o);
      r.t = s;
...
const C = (n, e, t, o, i) => n.ta(e, t, o, i), D = (n, e, t, o, i) => n.tr(e, t, o, i), hi = (n, e, t, o, i) => n.ts(e, t, o, i), g = (n, e, t, o, i) => n.tt(e, t, o, i), pe = "WORD", Ho = "UWORD", Es = "ASCIINUMERICAL", ws = "ALPHANUMERICAL", et = "LOCALHOST", jo = "TLD", Fo = "UTLD", gt = "SCHEME", _e = "SLASH_SCHEME", Fn = "NUM", $o = "WS", $n = "NL", Ke = "OPENBRACE", Ye = "CLOSEBRACE", Ct = "OPENBRACKET", Bt = "CLOSEBRACKET", St = "OPENPAREN", It = "CLOSEPAREN", Ot = "OPENANGLEBRACKET", At = "CLOSEANGLEBRACKET", Lt = "FULLWIDTHLEFTPAREN", _t = "FULLWIDTHRIGHTPAREN", Mt = "LEFTCORNERBRACKET", Nt = "RIGHTCORNERBRACKET", Pt = "LEFTWHITECORNERBRACKET", Dt = "RIGHTWHITECORNERBRACKET", Rt = "FULLWIDTHLESSTHAN", Ht = "FULLWIDTHGREATERTHAN", jt = "AMPERSAND", Ft = "APOSTROPHE", $t = "ASTERISK", ve = "AT", Ut = "BACKSLASH", zt = "BACKTICK", Wt = "CARET", ke = "COLON", Un = "COMMA", Kt = "DOLLAR", ae = "DOT", Yt = "EQUALS", zn = "EXCLAMATION", oe = "HYPHEN", Ve = "PERCENT", Vt = "PIPE", qt = "PLUS", Xt = "POUND", qe = "QUERY", Wn = "QUOTE", Ts = "FULLWIDTHMIDDLEDOT", Kn = "SEMI", le = "SLASH", Xe = "TILDE", Gt = "UNDERSCORE", xs = "EMOJI", Qt = "SYM";
var Cs = /* @__PURE__ */ Object.freeze({
  ...
  EQUALS: Yt,
  EXCLAMATION: zn,
  FULLWIDTHGREATERTHAN: Ht,
  FULLWIDTHLEFTPAREN: Lt,
  FULLWIDTHLESSTHAN: Rt,
  FULLWIDTHMIDDLEDOT: Ts,
  FULLWIDTHRIGHTPAREN: _t,
  HYPHEN: oe,
...
const ue = /[a-z]/, Fe = /\p{L}/u, Eo = /\p{Emoji}/u, he = /\d/, wo = /\s/, pi = "\r", To = `
`, bc = "️", vc = "‍", xo = "￼";
let at = null, lt = null;
function kc(n = []) {
  const e = {};
  Z.groups = e;
  const t = new Z();
  at == null && (at = fi(uc)), lt == null && (lt = fi(hc)), g(t, "'", Ft), g(t, "{", Ke), g(t, "}", Ye), g(t, "[", Ct), g(t, "]", Bt), g(t, "(", St), g(t, ")", It), g(t, "<", Ot), g(t, ">", At), g(t, "（", Lt), g(t, "）", _t), g(t, "「", Mt), g(t, "」", Nt), g(t, "『", Pt), g(t, "』", Dt), g(t, "＜", Rt), g(t, "＞", Ht), g(t, "&", jt), g(t, "*", $t), g(t, "@", ve), g(t, "`", zt), g(t, "^", Wt), g(t, ":", ke), g(t, ",", Un), g(t, "$", Kt), g(t, ".", ae), g(t, "=", Yt), g(t, "!", zn), g(t, "-", oe), g(t, "%", Ve), g(t, "|", Vt), g(t, "+", qt), g(t, "#", Xt), g(t, "?", qe), g(t, '"', Wn), g(t, "/", le), g(t, ";", Kn), g(t, "~", Xe), g(t, "_", Gt), g(t, "\\", Ut), g(t, "・", Ts);
  const o = D(t, he, Fn, {
    [No]: !0
  });
  D(o, he, o);
  ...
  D(r, he, i), D(r, ue, r), D(i, he, i), D(i, ue, i);
  const a = D(t, Fe, Ho, {
    [Do]: !0
  });
  D(a, ue), D(a, he, s), D(a, Fe, a), D(s, he, s), D(s, ue), D(s, Fe, s);
  const l = g(t, To, $n, {
    [yo]: !0
  }), c = g(t, pi, $o, {
    [yo]: !0
  ...
  g(t, xo, d), g(c, To, l), g(c, xo, d), D(c, wo, d), g(d, pi), g(d, To), D(d, wo, d), g(d, xo, d);
  const u = D(t, Eo, xs, {
    [ys]: !0
  });
  g(u, "#"), D(u, Eo, u), g(u, bc, u);
  const p = g(u, vc);
  g(p, "#"), D(p, Eo, u);
  const m = [[ue, r], [he, i]], f = [[ue, null], [Fe, a], [he, s]];
  ...
  xe(jo, {
    ...
    utld: !0,
    alpha: !0
  }, e), be(t, "file", gt, pe, m), be(t, "mailto", gt, pe, m), be(t, "http", _e, pe, m), be(t, "https", _e, pe, m), be(t, "ftp", _e, pe, m), be(t, "ftps", _e, pe, m), xe(gt, {
    scheme: !0,
    ascii: !0
  }, e), xe(_e, {
    slashscheme: !0,
    ascii: !0
  }, e), n = n.sort((b, T) => b[0] > T[0] ? 1 : -1);
  for (let b = 0; b < n.length; b++) {
    const T = n[b][0], x = n[b][1] ? {
      [pc]: !0
    } : {
      [fc]: !0
    };
    T.indexOf("-") >= 0 ? x[Ro] = !0 : ue.test(T) ? he.test(T) ? x[We] = !0 : x[Po] = !0 : x[No] = !0, hi(t, T, T, x);
  }
  return hi(t, "localhost", et, {
    ascii: !0
  }), t.jd = new Z(Qt), {
    start: t,
...
function Bs(n, e) {
  const t = yc(e.replace(/[A-Z]/g, (a) => a.toLowerCase())), o = t.length, i = [];
  let s = 0, r = 0;
  for (; r < o; ) {
    let a = n, l = null, c = 0, d = null, u = -1, p = -1;
    for (; r < o && (l = a.go(t[r])); )
      a = l, a.accepts() ? (u = 0, p = 0, d = a) : u >= 0 && (u += t[r].length, p++), c += t[r].length, s += t[r].length, r++;
    s -= u, r -= p, c -= u, i.push({
      t: d.t,
      // token type/name
      v: e.slice(s - c, s),
...
function yc(n) {
  ...
  let o = 0;
  for (; o < t; ) {
    let i = n.charCodeAt(o), s, r = i < 55296 || i > 56319 || o + 1 === t || (s = n.charCodeAt(o + 1)) < 56320 || s > 57343 ? n[o] : n.slice(o, o + 2);
    e.push(r), o += r.length;
  }
  return e;
}
function be(n, e, t, o, i) {
  ...
  for (let a = 0; a < r - 1; a++) {
    const l = e[a];
    n.j[l] ? s = n.j[l] : (s = new Z(o), s.jr = i.slice(), n.j[l] = s), n = s;
  }
  return s = new Z(t), s.jr = i.slice(), n.j[e[r - 1]] = s, s;
}
function fi(n) {
  const e = [], t = [];
  ...
  for (; o < n.length; ) {
    let s = 0;
    for (; i.indexOf(n[o + s]) >= 0; )
      s++;
    if (s > 0) {
      e.push(t.join(""));
      for (let r = parseInt(n.substring(o, o + s), 10); r > 0; r--)
        t.pop();
      o += s;
    } else
      t.push(n[o]), o++;
...
lo.prototype = {
  ...
  get(n, e, t) {
    const o = e != null;
    let i = this.o[n];
    return i && (typeof i == "object" ? (i = t.t in i ? i[t.t] : tt[n], typeof i == "function" && o && (i = i(e, t))) : typeof i == "function" && o && (i = i(e, t.t, t)), i);
  },
  /**
...
Ss.prototype = {
   ...
   */
  toFormattedString(n) {
    const e = this.toString(), t = n.get("truncate", e, this), o = n.get("format", e, this);
  ...
  */
   ...
   */
  render(n) {
    const e = this, t = this.toHref(n.get("defaultProtocol")), o = n.get("formatHref", t, this), i = n.get("tagName", t, e), s = this.toFormattedString(n), r = {}, a = n.get("className", t, e), l = n.get("target", t, e), c = n.get("rel", t, e), d = n.getObj("attributes", t, e), u = n.getObj("events", t, e);
    return r.href = o, a && (r.class = a), l && (r.target = l), c && (r.rel = c), d && Object.assign(r, d), {
      tagName: i,
      attributes: r,
      content: s,
      eventListeners: u
...
const mi = co("email", {
  ...
  */
  ...
  hasProtocol() {
    const n = this.tk;
    return n.length >= 2 && n[0].t !== et && n[1].t === ke;
  }
}), te = (n) => new Z(n);
function wc({
  groups: n
}) {
  const e = n.domain.concat([jt, $t, ve, Ut, zt, Wt, Kt, Yt, oe, Fn, Ve, Vt, qt, Xt, le, Qt, Xe, Gt]), t = [Ft, ke, Un, ae, zn, Ve, qe, Wn, Kn, Ot, At, Ke, Ye, Bt, Ct, St, It, Lt, _t, Mt, Nt, Pt, Dt, Rt, Ht], o = [jt, Ft, $t, Ut, zt, Wt, Kt, Yt, oe, Ke, Ye, Ve, Vt, qt, Xt, qe, le, Qt, Xe, Gt], i = te(), s = g(i, Xe);
  C(s, o, s), C(s, n.domain, s);
  const r = te(), a = te(), l = te();
  C(i, n.domain, r), C(i, n.scheme, a), C(i, n.slashscheme, l), C(r, o, s), C(r, n.domain, r);
  const c = g(r, ve);
  g(s, ve, c), g(a, ve, c), g(l, ve, c);
  const d = g(s, ae);
  C(d, o, s), C(d, n.domain, s);
  const u = te();
  C(c, n.domain, u), C(u, n.domain, u);
  const p = g(u, ae);
  C(p, n.domain, u);
  const m = te(mi);
  C(p, n.tld, m), C(p, n.utld, m), g(c, et, m);
  const f = g(u, oe);
  g(f, oe, f), C(f, n.domain, u), C(m, n.domain, u), g(m, ae, p), g(m, oe, f);
  const b = g(m, ke);
  C(b, n.numeric, mi);
  const T = g(r, oe), B = g(r, ae);
  g(T, oe, T), C(T, n.domain, r), C(B, o, s), C(B, n.domain, r);
  const x = te(ct);
  C(B, n.tld, x), C(B, n.utld, x), C(x, n.domain, r), C(x, o, s), g(x, ae, B), g(x, oe, T), g(x, ve, c);
  const ee = g(x, ke), $ = te(ct);
  C(ee, n.numeric, $);
  const L = te(ct), V = te();
  C(L, e, L), C(L, t, V), C(V, e, L), C(V, t, V), g(x, le, L), g($, le, L);
  const se = g(a, ke), y = g(l, ke), v = g(y, le), E = g(v, le);
  C(a, n.domain, r), g(a, ae, B), g(a, oe, T), C(l, n.domain, r), g(l, ae, B), g(l, oe, T), C(se, n.domain, L), g(se, le, L), g(se, qe, L), C(E, n.domain, L), C(E, e, L), g(E, le, L);
  const O = [
    [Ke, Ye],
    // {}
    [Ct, Bt],
  ...
  for (let _ = 0; _ < O.length; _++) {
    const [A, H] = O[_], S = g(L, A);
    g(V, A, S), g(S, H, L);
    const F = te(ct);
    C(S, e, F);
    const re = te();
    C(S, t), C(F, e, F), C(F, t, re), C(re, e, F), C(re, t, re), g(F, H, L), g(re, H, L);
  }
  return g(i, et, x), g(i, $n, Ec), {
    start: i,
    tokens: Cs
  };
}
function Tc(n, e, t) {
  let o = t.length, i = 0, s = [], r = [];
  for (; i < o; ) {
    let a = n, l = null, c = null, d = 0, u = null, p = -1;
    for (; i < o && !(l = a.go(t[i].t)); )
      r.push(t[i++]);
    for (; i < o && (c = l || a.go(t[i].t)); )
      l = null, a = c, a.accepts() ? (p = 0, u = a) : p >= 0 && p++, i++, d++;
    if (p < 0)
      i -= d, i < o && (r.push(t[i]), i++);
    else {
      r.length > 0 && (s.push(Co(bi, e, r)), r = []), i -= p, d -= p;
      const m = u.t, f = t.slice(i - d, i);
      s.push(Co(m, e, f));
    }
  }
  return r.length > 0 && s.push(Co(bi, e, r)), s;
}
function Co(n, e, t) {
  const o = t[0].s, i = t[t.length - 1].e, s = e.slice(o, i);
  return new n(s, t);
}
const K = {
  scanner: null,
...
function xc() {
  K.scanner = kc(K.customSchemes);
  for (let n = 0; n < K.tokenQueue.length; n++)
    K.tokenQueue[n][1]({
      scanner: K.scanner
    });
  K.parser = wc(K.scanner.tokens);
...
function Yn(n) {
  return K.initialized || xc(), Tc(K.parser.start, n, Bs(K.scanner.start, n));
}
Yn.scan = Bs;
function Is(n) {
...
function Os(n, e = {}) {
  ...
  for (let i = 0; i < t.length; i++) {
    const s = t[i];
    s.t === "nl" && e.get("nl2br") ? o.push(`<br>
`) : !s.isLink || !e.check(s) ? o.push(Is(s.toString())) : o.push(e.render(s));
  }
  return o.join("");
}
...
var Ic = {
  ...
  nbsp: " ",
  quot: '"'
}, Oc = /^#[xX]([A-Fa-f0-9]+)$/, Ac = /^#([0-9]+)$/, Lc = /^([A-Za-z0-9]+)$/, _c = (
  /** @class */
  function() {
    function n(e) {
      this.named = e;
...
`) {
        ...
        data: function() {
          var i = this.peek(), s = this.tagNameBuffer;
          i === "<" && !this.isIgnoredEndTag() ? (this.delegate.finishData(), this.transitionTo(
            "tagOpen"
            /* tagOpen */
          ), this.markTagStart(), this.consume()) : i === "&" && s !== "script" && s !== "style" ? (this.consume(), this.delegate.appendToData(this.consumeCharRef() || "&")) : (this.consume(), this.delegate.appendToData(i));
        },
        tagOpen: function() {
          var i = this.consume();
          i === "!" ? this.transitionTo(
        ...
        markupDeclarationOpen: function() {
          ...
          if (i === "-" && this.peek() === "-")
            ...
            var s = i.toUpperCase() + this.input.substring(this.index, this.index + 6).toUpperCase();
            s === "DOCTYPE" && (this.consume(), this.consume(), this.consume(), this.consume(), this.consume(), this.consume(), this.transitionTo(
              "doctype"
              /* doctype */
        ...
        afterDoctypeName: function() {
          ...
          if (!W(i))
            if (i === ">")
              ...
              var s = i.toUpperCase() + this.input.substring(this.index, this.index + 5).toUpperCase(), r = s.toUpperCase() === "PUBLIC", a = s.toUpperCase() === "SYSTEM";
              (r || a) && (this.consume(), this.consume(), this.consume(), this.consume(), this.consume(), this.consume()), r ? this.transitionTo(
        ...
        betweenDoctypePublicAndSystemIdentifiers: function() {
          var i = this.consume();
          W(i) || (i === ">" ? (this.delegate.endDoctype && this.delegate.endDoctype(), this.transitionTo(
            "beforeData"
            /* beforeData */
          )) : i === '"' ? this.transitionTo(
            "doctypeSystemIdentifierDoubleQuoted"
        ...
        beforeAttributeValue: function() {
          var i = this.peek();
          W(i) ? this.consume() : i === '"' ? (this.transitionTo(
        ...
        attributeValueUnquoted: function() {
          var i = this.peek();
          W(i) ? (this.delegate.finishAttributeValue(), this.consume(), this.transitionTo(
            "beforeAttributeName"
            /* beforeAttributeName */
        ...
        afterAttributeValueQuoted: function() {
          var i = this.peek();
          W(i) ? (this.consume(), this.transitionTo(
            "beforeAttributeName"
            /* beforeAttributeName */
          )) : i === "/" ? (this.consume(), this.transitionTo(
            "selfClosingStartTag"
    ...
    return n.prototype.reset = function() {
      ...
      for (this.input += Dc(e); this.index < this.input.length; ) {
...
` ? (this.line++, this.column = 0) : this.column++, e;
  ...
  function() {
    function n(e, t) {
      t === void 0 && (t = {}), this.options = t, this.token = null, this.startLine = 1, this.startColumn = 0, this.tokens = [], this.tokenizer = new Rc(this, e, t.mode), this._currentAttribute = void 0;
    }
...
function jc(n, e) {
  var t = new Hc(new _c(Ic), e);
  return t.tokenize(n);
}
const As = "LinkifyResult", Zt = "StartTag", Ls = "EndTag", Uo = "Chars", Fc = "Comment", $c = "Doctype";
function Uc(n, e = {}) {
  const t = jc(n), o = [], i = [], s = new lo(e, Kc);
  for (let r = 0; r < t.length; r++) {
    const a = t[r];
    if (a.type === Zt) {
      o.push(a);
      const l = a.tagName.toUpperCase();
      if (!(l === "A" || s.ignoreTags.indexOf(l) >= 0))
        continue;
      let d = o.length;
      Wc(l, t, ++r, o), r += o.length - d - 1;
    } else if (a.type !== Uo)
      o.push(a);
    else {
      const l = zc(a.chars, s);
      o.push.apply(o, l);
    }
  }
  for (let r = 0; r < o.length; r++) {
    ...
    switch (a.type) {
      ...
      case Zt: {
        let l = "<" + a.tagName;
        a.attributes.length > 0 && (l += " " + Vc(a.attributes).join(" ")), a.selfClosing && (l += " /"), l += ">", i.push(l);
        break;
      }
      case Ls:
        i.push(`</${a.tagName}>`);
...
function zc(n, e) {
  ...
  for (let i = 0; i < t.length; i++) {
    const s = t[i];
    s.t === "nl" && e.get("nl2br") ? o.push({
      type: Zt,
      tagName: "br",
      attributes: [],
      selfClosing: !0
    }) : !s.isLink || !e.check(s) ? o.push({
      type: Uo,
      chars: s.toString()
    }) : o.push({
      type: As,
...
function Wc(n, e, t, o) {
  ...
  for (; t < e.length && i > 0; ) {
    let s = e[t];
    s.type === Zt && s.tagName.toUpperCase() === n ? i++ : s.type === Ls && s.tagName.toUpperCase() === n && i--, o.push(s), t++;
  }
  return o;
}
function Kc({
...
const Ms = class Ns extends I {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    if ((i.includes ? i.includes("Files") : i.contains("Files")) && !ie(this.toolsFiles)) {
    ...
    const c = Object.keys(this.toolsTags).reduce((p, m) => (p[m.toLowerCase()] = this.toolsTags[m].sanitizationConfig ?? {}, p), {}), d = Object.assign({}, c, o.getAllInlineToolsSanitizeConfig(), { br: {} }), u = ce(l, d);
  ...
  async processText(e, t = !1) {
    const { Caret: o, BlockManager: i } = this.Editor, s = t ? this.processHTML(Uc(e)) : this.processPlain(e);
    if (!s.length)
      return;
    if (s.length === 1) {
   ...
   */
  collectTagNames(e) {
    return me(e) ? [e] : z(e) ? Object.keys(e) : [];
  }
  /**
  ...
  getFilesConfig(e) {
    ...
    !o && !i || (o && !Array.isArray(o) && (M(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (M(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter((s) => Qs(s) ? !0 : (M(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
      extensions: o || [],
      mimeTypes: i || []
    });
  }
   ...
   */
  getPatternsConfig(e) {
    e.pasteConfig === !1 || !e.pasteConfig.patterns || ie(e.pasteConfig.patterns) || Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
   ...
   */
  async processFile(e) {
    const t = Gs(e), o = Object.entries(this.toolsFiles).find(([r, { mimeTypes: a, extensions: l }]) => {
      const [c, d] = e.type.split("/"), u = l.find((m) => m.toLowerCase() === t.toLowerCase()), p = a.find((m) => {
        const [f, b] = m.split("/");
        return f === c && (b === d || b === "*");
      });
      return !!u || !!p;
  ...
  processHTML(e) {
    ...
    return o.innerHTML = e, this.getNodes(o).map((s) => {
      ...
      const { tags: c } = a.pasteConfig || { tags: [] }, d = c.reduce((m, f) => (this.collectTagNames(f).forEach((T) => {
        const B = z(f) ? f[T] : null;
        m[T.toLowerCase()] = B || {};
      }), m), {}), u = Object.assign({}, d, a.baseSanitizeConfig);
      if (r.tagName.toLowerCase() === "table") {
        const m = ce(r.outerHTML, u);
        r = h.make("div", void 0, {
          innerHTML: m
        }).firstChild;
      } else
        r.innerHTML = ce(r.innerHTML, u);
...
Ms.PATTERN_PROCESSING_MAX_LENGTH = 450;
let qc = Ms;
class Xc extends I {
  constructor() {
...
class Ge extends I {
  ...
  enableModuleBindings() {
    ...
    }, !1), this.listeners.on(document.body, "mousemove", Bo((t) => {
      this.processMouseMove(t);
    }, 10), {
      passive: !0
    }), this.listeners.on(document.body, "mouseleave", () => {
      this.processMouseLeave();
    }), this.listeners.on(window, "scroll", Bo((t) => {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = h.make("div", Ge.CSS.overlay, {}), i = h.make("div", Ge.CSS.overlayContainer, {}), s = h.make("div", Ge.CSS.rect, {});
  ...
  changingRectangle(e) {
    ...
    this.rectCrossesBlocks = !(s || r), this.isRectSelectionActivated || (this.rectCrossesBlocks = !1, this.isRectSelectionActivated = !0, this.shrinkRectangleToPoint(), this.overlayRectangle.style.display = "block"), this.updateRectangleSize(), this.Editor.Toolbar.close(), i !== void 0 && (this.trySelectNextBlock(i), this.inverseSelection(), k.get().removeAllRanges());
  }
  /**
  ...
  genInfoForMouseSelection() {
    ...
    const a = this.Editor.BlockManager.lastBlock.holder.querySelector("." + U.CSS.content), l = Number.parseInt(window.getComputedStyle(a).width, 10) / 2, c = t - l, d = t + l;
    return {
      index: r,
      leftPos: c,
      rightPos: d
  ...
  trySelectNextBlock(e) {
    ...
    if (!p && e < this.stackOfSelected[o - 1]) {
      for (let b = this.stackOfSelected[o - 1] - 1; b >= e; b--)
        this.addBlockInSelection(b);
      return;
    }
    if (!p)
      return;
    let m = o - 1, f;
    for (e > this.stackOfSelected[o - 1] ? f = () => e > this.stackOfSelected[m] : f = () => e < this.stackOfSelected[m]; f(); )
    ...
    return new Promise((t) => {
      ...
      if (e.length === 0)
        ...
        const s = e.map(({ type: r, data: a, tunes: l, id: c }) => {
          o.available.has(r) === !1 && (ne(`Tool «${r}» is not found. Check 'tools' property at the Editor.js config.`, "warn"), a = this.composeStubDataForTool(r, a, c), r = o.stubTool);
          let d;
          try {
            d = i.composeBlock({
              id: c,
...
class Qc extends I {
  ...
  async save() {
    ...
    try {
      ...
      const s = await Promise.all(i), r = await Yo(s, (a) => t.blockTools.get(a).sanitizeConfig);
      return this.makeOutput(r);
    } catch (s) {
      ne("Saving failed due to the Error %o", "error", s);
    }
  }
  /**
   * Saves and validates
...
const Zc = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';
function Jc(n) {
  const e = document.createElement("div");
  e.innerHTML = n.trim();
  const t = document.createDocumentFragment();
...
class Vn {
  ...
  constructor({ data: e, config: t, api: o, readOnly: i }) {
    ...
    }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = t.placeholder ? t.placeholder : Vn.DEFAULT_PLACEHOLDER, this._data = e ?? {}, this._element = null, this._preserveBlank = t.preserveBlank ?? !1;
  }
  /**
...
class Gn {
  ...
  checkState() {
    ...
    if (e) {
      this.nodes.button.innerHTML = ta, this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
      const t = e.getAttribute("href");
      this.nodes.input.defaultValue = t !== "null" ? t : "", this.selection.save();
    } else
      this.nodes.button.innerHTML = ii, this.nodes.button.classList.remove(this.CSS.buttonUnlink), this.nodes.button.classList.remove(this.CSS.buttonActive);
    return !!e;
  }
  /**
  ...
  async render() {
    ...
    const s = i.reduce((c, d) => {
      ...
      return (u = d.toolbox) == null || u.forEach((p) => {
        c.push({
          icon: p.icon,
          title: X.t(J.toolNames, p.title),
          name: d.name,
          closeOnActivate: !0,
          onActivate: async () => {
            const m = await this.blocksAPI.convert(t.id, d.name, p.data);
            this.caretAPI.setToBlock(m, "end");
          }
        });
      }), c;
    }, []), r = await t.getActiveToolboxEntry(), a = r !== void 0 ? r.icon : Di, l = !De();
    return {
      icon: a,
      name: "convert-to",
      hint: {
...
class Ds {
   ...
   */
  make() {
    const e = h.make("div", this.CSS.wrapper), t = oa, o = h.make("div", this.CSS.info), i = h.make("div", this.CSS.title, {
...
class ed extends Zo {
   ...
   */
  get title() {
    return this.constructable[Tt.Title];
  }
  /**
  ...
  get isReadOnlySupported() {
    return this.constructable[Tt.IsReadOnlySupported] ?? !1;
  }
}
class td extends Zo {
  constructor() {
...
var od = Object.defineProperty, nd = Object.getOwnPropertyDescriptor, Rs = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? nd(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && od(e, t, i), i;
};
class Qn extends Zo {
  constructor() {
    super(...arguments), this.type = Ce.Block, this.inlineTools = new Y(), this.tunes = new Y();
  }
  /**
   ...
   */
  get isReadOnlySupported() {
    return this.constructable[Le.IsReadOnlySupported] === !0;
  }
  /**
   * Returns true if Tool supports linebreaks
   */
  get isLineBreaksEnabled() {
    return this.constructable[Le.IsEnabledLineBreaks];
  }
  /**
   ...
   */
  get toolbox() {
    const e = this.constructable[Le.Toolbox], t = this.config[ut.Toolbox];
    if (!ie(e) && t !== !1)
  ...
  get conversionConfig() {
    return this.constructable[Le.ConversionConfig];
  }
  /**
   * Returns enabled inline tools for Tool
   */
  get enabledInlineTools() {
    return this.config[ut.EnabledInlineTools] || !1;
  }
  /**
   * Returns enabled tunes for Tool
   */
  get enabledBlockTunes() {
    return this.config[ut.EnabledBlockTunes];
  }
  /**
   * Returns Tool paste configuration
   */
  get pasteConfig() {
    return this.constructable[Le.PasteConfig] ?? {};
  }
  get sanitizeConfig() {
    ...
    for (const i in e)
      if (Object.prototype.hasOwnProperty.call(e, i)) {
        const s = e[i];
        z(s) ? o[i] = Object.assign({}, t, s) : o[i] = s;
      }
    return o;
  }
...
Rs([
  Pe
], Qn.prototype, "sanitizeConfig", 1);
Rs([
  Pe
], Qn.prototype, "baseSanitizeConfig", 1);
class id {
  /**
   * @class
   ...
   */
  get(e) {
    const { class: t, isInternal: o = !1, ...i } = this.config[e], s = this.getConstructor(t), r = t[_o.IsTune];
    return new s({
      name: e,
      constructable: t,
      config: i,
...
Fs.isTune = !0;
var sd = Object.defineProperty, rd = Object.getOwnPropertyDescriptor, ad = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? rd(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
...
class $s extends I {
   ...
   */
  async prepare() {
    if (this.validateTools(), this.config.tools = So({}, this.internalTools, this.config.tools), !Object.prototype.hasOwnProperty.call(this.config, "tools") || Object.keys(this.config.tools).length === 0)
      throw Error("Can't start without tools");
    const e = this.prepareConfig();
    this.factory = new id(e, this.config, this.Editor.API);
  ...
  getListOfPrepareFunctions(e) {
    ...
    return Object.entries(e).forEach(([o, i]) => {
      t.push({
        ...
        function: P(i.class.prepare) ? i.class.prepare : () => {
        },
        data: {
          toolName: o,
          config: i.config
...
class cd extends I {
  ...
  get contentRect() {
    ...
    const e = this.nodes.wrapper.querySelector(`.${U.CSS.content}`);
  ...
  loadStyles() {
    ...
    const t = h.make("style", null, {
      id: e,
      textContent: ld.toString()
    });
    this.config.style && !ie(this.config.style) && this.config.style.nonce && t.setAttribute("nonce", this.config.style.nonce), h.prepend(document.head, t);
  }
  /**
  ...
  watchBlockHoveredEvents() {
    let e;
    this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", Bo((t) => {
      const o = t.target.closest(".ce-block");
      this.Editor.BlockSelection.anyBlockSelected || o && e !== o && (e = o, this.eventsDispatcher.emit(Yi, {
  ...
  redactorClicked(e) {
    ...
    if (i && o) {
      ...
      const s = i.getAttribute("href"), r = Js(s);
      tr(r);
      return;
    }
  ...
  selectionChanged() {
    ...
    const i = o.closest(`.${U.CSS.content}`);
...
const dd = {
  ...
  BlockSelection: sc,
  Caret: xt,
  CrossBlockSelection: rc,
  DragNDrop: ac,
  ModificationsObserver: dc,
  Paste: qc,
  ReadOnly: Xc,
  RectangleSelection: Ge,
  Renderer: Gc,
  Saver: Qc,
  Tools: $s,
  UI: cd
...
class ud {
   ...
   */
  constructor(e) {
    this.moduleInstances = {}, this.eventsDispatcher = new nt();
    let t, o;
  ...
  set configuration(e) {
    ...
    z(e) ? this.config = {
      ...
      holder: e
    }, Io(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = ki.VERBOSE), Vs(this.config.logLevel), Io(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const t = {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (ie(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && X.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
  ...
  exportAPI(e) {
    const t = ["configuration"], o = () => {
      Object.values(e.moduleInstances).forEach((s) => {
        P(s.destroy) && s.destroy(), s.listeners.removeAll();
      }), jr(), e = null;
      for (const s in this)
