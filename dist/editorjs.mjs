...
let jn = (n = 21) => crypto.getRandomValues(new Uint8Array(n)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
var jo = /* @__PURE__ */ ((n) => (n.VERBOSE = "VERBOSE", n.INFO = "INFO", n.WARN = "WARN", n.ERROR = "ERROR", n))(jo || {});
const C = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
function nt(n, e, t = "log", o, i = "color: inherit") {
...
const R = nt.bind(window, !1), ce = nt.bind(window, !0);
function Se(n) {
...
async function Wn(n, e = () => {
  ...
  async function o(i, s, r) {
    try {
      await i.function(i.data), await s(Io(i.data) ? {} : i.data);
    } catch {
      r(Io(i.data) ? {} : i.data);
    }
  }
...
function jt(n, ...e) {
  ...
  if (X(n) && X(t))
    for (const o in t)
      X(t[o]) ? (n[o] || Object.assign(n, { [o]: {} }), jt(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
  return jt(n, ...e);
}
function yt(n) {
  const e = Xn();
...
const qo = 650;
function Te() {
  return window.matchMedia(`(max-width: ${qo}px)`).matches;
}
const _o = typeof window < "u" && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1);
function ei(n, e) {
...
class h {
  ...
  static findAllInputs(e) {
    return Ko(e.querySelectorAll(h.allInputsSelector)).reduce((t, o) => h.isNativeInput(o) || h.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...h.getDeepestBlockElements(o)], []);
  }
  /**
  ...
  static isElement(e) {
    return Lo(e) ? !1 : e && e.nodeType && e.nodeType === Node.ELEMENT_NODE;
  }
  /**
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  static isFragment(e) {
    return Lo(e) ? !1 : e && e.nodeType && e.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
  }
  /**
...
class wt {
   ...
   */
  emit(e, t) {
    ae(this.subscribers) || !this.subscribers[e] || this.subscribers[e].reduce((o, i) => {
      const s = i(o);
      return s !== void 0 ? s : o;
    }, t);
  }
...
class O {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    if (this.nodes = {}, this.listeners = new oo(), this.readOnlyMutableListeners = {
      /**
...
class x {
  ...
  static get rect() {
    ...
    if (!window.getSelection)
      return R("Method window.getSelection is not supported", "warn"), o;
    if (e = window.getSelection(), e.rangeCount === null || isNaN(e.rangeCount))
      return R("Method SelectionUtils.rangeCount is not supported", "warn"), o;
    if (e.rangeCount === 0)
      return o;
...
const Kt = "redactor dom changed", Yo = "block changed", Xo = "fake cursor is about to be toggled", Go = "fake cursor have been set";
function No(n, e) {
  return n.mergeable && n.name === e.name;
}
function ri(n, e) {
  const t = e == null ? void 0 : e.export;
  return j(t) ? t(n) : ve(t) ? n[t] : (t !== void 0 && R("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function ai(n, e) {
  const t = e == null ? void 0 : e.import;
  return j(t) ? t(n) : ve(t) ? {
    [t]: n
  } : (t !== void 0 && R("Conversion «import» property must be a string or function. String means key of tool data to import. Function accepts a imported string and return composed tool data."), {});
}
var fe = /* @__PURE__ */ ((n) => (n.APPEND_CALLBACK = "appendCallback", n.RENDERED = "rendered", n.MOVED = "moved", n.UPDATED = "updated", n.REMOVED = "removed", n.ON_PASTE = "onPaste", n))(fe || {});
class V extends wt {
  /**
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      let d;
      c || u ? d = !0 : d = !(l.length > 0 && l.every((b) => {
        const { addedNodes: f, removedNodes: y, target: P } = b;
        return [
          ...Array.from(f),
          ...Array.from(y),
          P
        ].some((N) => (h.isElement(N) || (N = N.parentElement), N && N.closest('[data-mutation-free="true"]') !== null));
      })), d && (this.dropInputsCache(), this.updateCurrentInput(), this.call(
        "updated"
        /* UPDATED */
      ), this.emit("didMutated", this));
    }, this.name = o.name, this.id = e, this.settings = o.settings, this.config = o.settings.config || {}, this.api = i, this.editorEventBus = a || null, this.blockAPI = new we(this), this.tool = o, this.toolInstance = o.create(t, this.blockAPI, s), this.tunes = o.tunes, this.composeTunes(r), this.holder = this.compose(), window.requestIdleCallback(() => {
   ...
   */
  get data() {
    return this.save().then((e) => e && !ae(e.data) ? e.data : {});
  }
  /**
  ...
  set selected(e) {
    var i, s;
    this.holder.classList.toggle(V.CSS.selected, e);
    const t = e === !0 && x.isRangeInsideContainer(this.holder), o = e === !1 && x.isFakeCursorInsideContainer(this.holder);
    (t || o) && ((i = this.editorEventBus) == null || i.emit(Xo, { state: e }), t ? x.addFakeCursor() : x.removeFakeCursor(this.holder), (s = this.editorEventBus) == null || s.emit(Go, { state: e }));
  }
  /**
   ...
   */
  get selected() {
    return this.holder.classList.contains(V.CSS.selected);
  }
  /**
   * Set stretched state
   *
   ...
   */
  set stretched(e) {
    this.holder.classList.toggle(V.CSS.wrapperStretched, e);
  }
  /**
   ...
   */
  get stretched() {
    return this.holder.classList.contains(V.CSS.wrapperStretched);
  }
  /**
   ...
   */
  set dropTarget(e) {
    this.holder.classList.toggle(V.CSS.dropTarget, e);
  }
  /**
  ...
  call(e, t) {
    if (j(this.toolInstance[e])) {
      ...
      try {
        ...
        R(`Error during '${e}' call: ${o.message}`, "error");
      }
    }
  }
  /**
  ...
  async save() {
    ...
    [
      ...
      if (j(r.save))
        try {
          ...
          R(`Tune ${r.constructor.name} save method throws an Error %o`, "warn", a);
        }
    });
    ...
    return Promise.resolve(e).then((s) => (i = window.performance.now(), {
      ...
      R(`Saving process for ${this.name} tool failed due to the ${s}`, "log", "red");
    });
  }
  /**
  ...
  getTunes() {
    ...
    return [o, i].flat().forEach((s) => {
      h.isElement(s) ? e.appendChild(s) : Array.isArray(s) ? t.push(...s) : t.push(s);
    }), [t, e];
  }
  /**
   ...
   */
  updateCurrentInput() {
    this.currentInput = h.isNativeInput(document.activeElement) || !x.anchorNode ? document.activeElement : x.anchorNode;
  }
  /**
   * Allows to say Editor that Block was changed. Used to manually trigger Editor's 'onChange' callback
   * Can be useful for block changes invisible for editor core.
  ...
  async getActiveToolboxEntry() {
    ...
    return e.find((i) => Object.entries(i.data).some(([s, r]) => t[s] && ei(t[s], r)));
  }
  /**
  ...
  async exportDataAsString() {
    ...
    return ri(e, this.tool.conversionConfig);
  }
  /**
   ...
   */
  compose() {
    const e = h.make("div", V.CSS.wrapper), t = h.make("div", V.CSS.content), o = this.toolInstance.render();
    ...
    return [...this.tunesInstances.values(), ...this.defaultTunesInstances.values()].forEach((s) => {
      if (j(s.wrap))
        try {
          ...
          R(`Tune ${s.constructor.name} wrap method throws an Error %o`, "warn", r);
        }
    }), e.appendChild(i), e;
  }
  /**
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (t) => {
      const { mutations: o } = t;
      o.some((s) => si(s, this.toolRenderedElement)) && this.didMutated(o);
    }, (e = this.editorEventBus) == null || e.on(Kt, this.redactorDomChangedCallback);
  }
  /**
  ...
  unwatchBlockMutations() {
    var e;
    (e = this.editorEventBus) == null || e.off(Kt, this.redactorDomChangedCallback);
  }
  /**
...
class li extends O {
  constructor() {
    super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, s, r, a) => {
      ...
      if (c && u)
        ...
        throw new Error(`Conversion from "${r.name}" to "${t}" is not possible. ${b} tool(s) should provide a "conversionConfig"`);
      }
      ...
      return this.Editor.BlockManager.insertMany(o, t), o.map((i) => new we(i));
    };
  }
  /**
   * Available methods
  ...
  getById(e) {
    const t = this.Editor.BlockManager.getBlockById(e);
    return t === void 0 ? (ce("There is no block with id `" + e + "`", "warn"), null) : new we(t);
  }
  /**
   ...
   */
  insertNewBlock() {
    R("Method blocks.insertNewBlock() is deprecated and it will be removed in the next major release. Use blocks.insert() instead.", "warn"), this.insert();
  }
  /**
          ...
          return this.map(function(r) {
            var a = function(l, c) {
              ...
              if (c && typeof btoa == "function") {
                ...
                return [u].concat(b).concat([p]).join(`
`);
              }
              var f;
              return [u].join(`
        ...
        for (var S = 0; S < k.length; S++) {
          ...
          if (D) {
            ...
            for (var I = 0; I < D.parts.length; I++)
              D.parts[I](B.parts[I]);
            for (; I < B.parts.length; I++)
              D.parts.push(w(B.parts[I], m));
          } else {
            var q = [];
            for (I = 0; I < B.parts.length; I++)
              q.push(w(B.parts[I], m));
            a[B.id] = { id: B.id, refs: 1, parts: q };
          }
        }
      }
      function y(k, m) {
        for (var S = [], B = {}, D = 0; D < k.length; D++) {
          var I = k[D], q = m.base ? I[0] + m.base : I[0], _ = { css: I[1], media: I[2], sourceMap: I[3] };
          B[q] ? B[q].parts.push(_) : S.push(B[q] = { id: q, parts: [_] });
        }
        return S;
      }
      function P(k, m) {
...
`);
          var D = c(k.insertInto + " " + k.insertAt.before);
          S.insertBefore(m, D);
        }
      }
      function z(k) {
      ...
      function N(k) {
        ...
        return k.attrs.type === void 0 && (k.attrs.type = "text/css"), T(m, k.attrs), P(k, m), m;
      }
      function T(k, m) {
      ...
      function w(k, m) {
        ...
        if (m.singleton) {
          var q = d++;
          S = u || (u = N(m)), B = U.bind(null, S, q, !1), D = U.bind(null, S, q, !0);
        } else
          k.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (S = function(_) {
            var ie = document.createElement("link");
            return _.attrs.type === void 0 && (_.attrs.type = "text/css"), _.attrs.rel = "stylesheet", T(ie, _.attrs), P(_, ie), ie;
          }(m), B = function(_, ie, je) {
            var ye = je.css, Dt = je.sourceMap, Fn = ie.convertToAbsoluteUrls === void 0 && Dt;
            (ie.convertToAbsoluteUrls || Fn) && (ye = b(ye)), Dt && (ye += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Dt)))) + " */");
            var zn = new Blob([ye], { type: "text/css" }), Oo = _.href;
            _.href = URL.createObjectURL(zn), Oo && URL.revokeObjectURL(Oo);
          }.bind(null, S, m), D = function() {
            z(S), S.href && URL.revokeObjectURL(S.href);
          }) : (S = N(m), B = function(_, ie) {
            var je = ie.css, ye = ie.media;
            if (ye && _.setAttribute("media", ye), _.styleSheet)
              _.styleSheet.cssText = je;
            else {
              for (; _.firstChild; )
                _.removeChild(_.firstChild);
              _.appendChild(document.createTextNode(je));
            }
          }.bind(null, S), D = function() {
            z(S);
          });
        return B(k), function(_) {
          if (_) {
            if (_.css === k.css && _.media === k.media && _.sourceMap === k.sourceMap)
              return;
            B(k = _);
          } else
            D();
      ...
      t.exports = function(k, m) {
        ...
        return f(S, m), function(B) {
          for (var D = [], I = 0; I < S.length; I++) {
            var q = S[I];
            (_ = a[q.id]).refs--, D.push(_);
          }
          for (B && f(y(B, m), m), I = 0; I < D.length; I++) {
            var _;
            if ((_ = D[I]).refs === 0) {
              for (var ie = 0; ie < _.parts.length; ie++)
                _.parts[ie]();
              delete a[_.id];
            }
          }
...
`);
      ...
      function U(k, m, S, B) {
        var D = S ? "" : B.css;
        if (k.styleSheet)
          k.styleSheet.cssText = M(m, D);
        else {
          var I = document.createTextNode(D), q = k.childNodes;
          q[m] && k.removeChild(q[m]), q.length ? k.insertBefore(I, q[m]) : k.appendChild(I);
        }
      }
    }, function(t, o) {
      t.exports = function(i) {
        ...
        return i.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(l, c) {
          var u, d = c.trim().replace(/^"(.*)"$/, function(p, b) {
            return b;
      ...
      var s, r, a, l, c, u, d, p, b;
      t.exports = (s = "cdx-notifies", r = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", u = "cdx-notify__input", d = "cdx-notify__button", p = "cdx-notify__btns-wrapper", { alert: b = function(f) {
        var y = document.createElement("DIV"), P = document.createElement("DIV"), z = f.message, N = f.style;
        return y.classList.add(r), N && y.classList.add(r + "--" + N), y.innerHTML = z, P.classList.add(a), P.addEventListener("click", y.remove.bind(y)), y.appendChild(P), y;
      }, confirm: function(f) {
        var y = b(f), P = document.createElement("div"), z = document.createElement("button"), N = document.createElement("button"), T = y.querySelector("." + a), w = f.cancelHandler, E = f.okHandler;
        return P.classList.add(p), z.innerHTML = f.okText || "Confirm", N.innerHTML = f.cancelText || "Cancel", z.classList.add(d), N.classList.add(d), z.classList.add(l), N.classList.add(c), w && typeof w == "function" && (N.addEventListener("click", w), T.addEventListener("click", w)), E && typeof E == "function" && z.addEventListener("click", E), z.addEventListener("click", y.remove.bind(y)), N.addEventListener("click", y.remove.bind(y)), P.appendChild(z), P.appendChild(N), y.appendChild(P), y;
      }, prompt: function(f) {
        var y = b(f), P = document.createElement("div"), z = document.createElement("button"), N = document.createElement("input"), T = y.querySelector("." + a), w = f.cancelHandler, E = f.okHandler;
        return P.classList.add(p), z.innerHTML = f.okText || "Ok", z.classList.add(d), z.classList.add(l), N.classList.add(u), f.placeholder && N.setAttribute("placeholder", f.placeholder), f.default && (N.value = f.default), f.inputType && (N.type = f.inputType), w && typeof w == "function" && T.addEventListener("click", w), E && typeof E == "function" && z.addEventListener("click", function() {
          E(N.value);
        }), z.addEventListener("click", y.remove.bind(y)), P.appendChild(N), P.appendChild(z), y.appendChild(P), y;
      }, getWrapper: function() {
    ...
    t.prototype.clean = function(d) {
      ...
      if (f)
        do {
          ...
          var y = r(f), P;
          y && (P = Array.prototype.some.call(f.childNodes, i));
          var z = !!p.parentNode, N = i(p) && i(f) && z, T = f.nodeName.toLowerCase(), w = l(this.config, T, f), E = y && P;
          if (E || c(f, w) || !this.config.keepNestedBlockElements && N) {
          ...
          for (var M = 0; M < f.attributes.length; M += 1) {
            var U = f.attributes[M];
            u(U, w, f) && (f.removeAttribute(U.name), M = M - 1);
          }
          this._sanitize(d, f);
...
function Zo(n, e) {
  return n.map((t) => {
    ...
    return ae(o) || (t.data = io(t.data, o)), t;
  });
}
function ge(n, e = {}) {
  const t = {
  ...
  return new xi(t).clean(n);
}
function io(n, e) {
  return Array.isArray(n) ? yi(n, e) : X(n) ? wi(n, e) : ve(n) ? Ei(n, e) : n;
}
function yi(n, e) {
  return n.map((t) => io(t, e));
}
function wi(n, e) {
  const t = {};
  for (const o in n) {
...
const Ii = /* @__PURE__ */ xt(Vt);
let J = null;
function so() {
  J || (J = new Ii());
}
function Mi(n, e, t) {
  so(), J == null || J.show(n, e, t);
}
function Yt(n = !1) {
  so(), J == null || J.hide(n);
}
function Ye(n, e, t) {
  so(), J == null || J.onHover(n, e, t);
}
function _i() {
...
function Qo(n, e) {
  ...
  return Object.entries(n).forEach(([o, i]) => {
    if (X(i)) {
      const s = e ? `${e}.${o}` : o;
      Object.values(i).every((a) => ve(a)) ? t[o] = s : t[o] = Qo(i, s);
      return;
    }
    t[o] = i;
  }), t;
...
const Pi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 12L9 7.1C9 7.04477 9.04477 7 9.1 7H10.4C11.5 7 14 7.1 14 9.5C14 9.5 14 12 11 12M9 12V16.8C9 16.9105 9.08954 17 9.2 17H12.5C14 17 15 16 15 14.5C15 11.7046 11 12 11 12M9 12H11"/></svg>', Jo = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 10L11.8586 14.8586C11.9367 14.9367 12.0633 14.9367 12.1414 14.8586L17 10"/></svg>', Hi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 15L11.8586 10.1414C11.9367 10.0633 12.0633 10.0633 12.1414 10.1414L17 15"/></svg>', Fi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 8L12 12M12 12L16 16M12 12L16 8M12 12L8 16"/></svg>', zi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/></svg>', Ui = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M13.34 10C12.4223 12.7337 11 17 11 17"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.21 7H14.2"/></svg>', Ro = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.69998 12.6L7.67896 12.62C6.53993 13.7048 6.52012 15.5155 7.63516 16.625V16.625C8.72293 17.7073 10.4799 17.7102 11.5712 16.6314L13.0263 15.193C14.0703 14.1609 14.2141 12.525 13.3662 11.3266L13.22 11.12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16.22 11.12L16.3564 10.9805C17.2895 10.0265 17.3478 8.5207 16.4914 7.49733V7.49733C15.5691 6.39509 13.9269 6.25143 12.8271 7.17675L11.3901 8.38588C10.0935 9.47674 9.95706 11.4241 11.0888 12.6852L11.12 12.72"/></svg>', ji = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 7.29999H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 7.29999H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.30999 12H9.3"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 12H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 16.7H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 16.7H14.59"/></svg>', $i = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 7V12M12 17V12M17 12H12M12 12H7"/></svg>', Ki = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="10.5" cy="10.5" r="5.5" stroke="currentColor" stroke-width="2"/><line x1="15.4142" x2="19" y1="15" y2="18.5858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', qi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M15.7795 11.5C15.7795 11.5 16.053 11.1962 16.5497 10.6722C17.4442 9.72856 17.4701 8.2475 16.5781 7.30145V7.30145C15.6482 6.31522 14.0873 6.29227 13.1288 7.25073L11.8796 8.49999"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8.24517 12.3883C8.24517 12.3883 7.97171 12.6922 7.47504 13.2161C6.58051 14.1598 6.55467 15.6408 7.44666 16.5869V16.5869C8.37653 17.5731 9.93744 17.5961 10.8959 16.6376L12.1452 15.3883"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M17.7802 15.1032L16.597 14.9422C16.0109 14.8624 15.4841 15.3059 15.4627 15.8969L15.4199 17.0818"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6.39064 9.03238L7.58432 9.06668C8.17551 9.08366 8.6522 8.58665 8.61056 7.99669L8.5271 6.81397"/><line x1="12.1142" x2="11.7" y1="12.2" y2="11.7858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', Wi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/><line x1="12" x2="12" y1="9" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 15.02V15.01"/></svg>';
class K {
  /**
   ...
   */
  make(e) {
    const t = h.make("div", K.CSS.container);
    return e.name && (t.dataset.itemName = e.name), this.nodes.icon = h.make("div", K.CSS.icon, {
      innerHTML: e.icon || zi
    }), t.appendChild(this.nodes.icon), t.appendChild(h.make("div", K.CSS.title, {
      innerHTML: e.title || ""
    })), e.secondaryLabel && t.appendChild(h.make("div", K.CSS.secondaryTitle, {
...
const $e = class {
  ...
  leafNodesAndReturnIndex(n) {
    if (this.items.length === 0)
      return this.cursor;
    let e = this.cursor;
    return e === -1 ? e = n === $e.directions.RIGHT ? -1 : 0 : this.items[e].classList.remove(this.focusedCssClass), n === $e.directions.RIGHT ? e = (e + 1) % this.items.length : e = (this.items.length + e - 1) % this.items.length, h.canSetCaret(this.items[e]) && bt(() => x.setCursor(this.items[e]), 50)(), this.items[e].classList.add(this.focusedCssClass), e;
  }
};
let Me = $e;
Me.directions = {
...
class be {
  ...
  constructor(e) {
    ...
    }, this.iterator = new Me(e.items, e.focusedItemClass), this.activateCallback = e.activateCallback, this.allowedKeys = e.allowedKeys || be.usedKeys;
  }
  /**
...
class qe {
  ...
  constructor({ items: e, onSearch: t, placeholder: o }) {
    this.listeners = new oo(), this.items = e, this.onSearch = t, this.render(o);
  }
  /**
   ...
   */
  render(e) {
    this.wrapper = h.make("div", qe.CSS.wrapper);
    const t = h.make("div", qe.CSS.icon, {
      innerHTML: Ki
    });
    this.input = h.make("input", qe.CSS.input, {
      placeholder: e,
      /**
...
const Ke = class {
   ...
   */
  lock() {
    _o ? this.lockHard() : document.body.classList.add(Ke.CSS.scrollLocked);
  }
  /**
   * Unlocks body element scroll
   */
  unlock() {
    _o ? this.unlockHard() : document.body.classList.remove(Ke.CSS.scrollLocked);
  }
  /**
...
var Vi = Object.defineProperty, Yi = Object.getOwnPropertyDescriptor, Xi = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Yi(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && Vi(e, t, i), i;
}, Xe = /* @__PURE__ */ ((n) => (n.Close = "close", n))(Xe || {});
const W = class extends wt {
  /**
   ...
   */
  constructor(n) {
    super(), this.scopeElement = document.body, this.listeners = new oo(), this.scrollLocker = new en(), this.nodes = {
      wrapper: null,
      popover: null,
   ...
   */
  show() {
    this.shouldOpenBottom || (this.nodes.popover.style.setProperty("--popover-height", this.height + "px"), this.nodes.popover.classList.add(W.CSS.popoverOpenTop)), this.nodes.overlay.classList.remove(W.CSS.overlayHidden), this.nodes.popover.classList.add(W.CSS.popoverOpened), this.flipper.activate(this.flippableElements), this.search !== void 0 && requestAnimationFrame(() => {
      var n;
   ...
   */
  hide() {
    this.nodes.popover.classList.remove(W.CSS.popoverOpened), this.nodes.popover.classList.remove(W.CSS.popoverOpenTop), this.nodes.overlay.classList.add(W.CSS.overlayHidden), this.flipper.deactivate(), this.items.forEach((n) => n.reset()), this.search !== void 0 && this.search.clear(), Te() && this.scrollLocker.unlock(), this.emit(
      "close"
      /* Close */
    );
  }
   ...
   */
  make() {
    this.nodes.popover = h.make("div", [W.CSS.popover]), this.nodes.nothingFoundMessage = h.make("div", [W.CSS.nothingFoundMessage], {
      textContent: this.messages.nothingFound
    }), this.nodes.popover.appendChild(this.nodes.nothingFoundMessage), this.nodes.items = h.make("div", [W.CSS.items]), this.items.forEach((n) => {
    ...
    }), this.nodes.wrapper = h.make("div"), this.nodes.overlay = h.make("div", [W.CSS.overlay, W.CSS.overlayHidden]), this.listeners.on(this.nodes.overlay, "click", () => {
      this.hide();
  ...
  addSearch() {
    ...
    n.classList.add(W.CSS.search), this.nodes.popover.insertBefore(n, this.nodes.popover.firstChild);
  }
  /**
   ...
   */
  addCustomContent(n) {
    this.nodes.customContent = n, this.nodes.customContent.classList.add(W.CSS.customContent), this.nodes.popover.insertBefore(n, this.nodes.popover.firstChild);
  }
  /**
  ...
  get height() {
    ...
    return e.style.visibility = "hidden", e.style.position = "absolute", e.style.top = "-1000px", e.classList.add(W.CSS.popoverOpened), document.body.appendChild(e), n = e.offsetHeight, e.remove(), n;
  }
  /**
  ...
  toggleNothingFoundMessage(n) {
    this.nodes.nothingFoundMessage.classList.toggle(W.CSS.nothingFoundMessageDisplayed, n);
  }
  /**
  ...
  toggleCustomContent(n) {
    var e;
    (e = this.nodes.customContent) == null || e.classList.toggle(W.CSS.customContentHidden, n);
  }
  /**
...
class Gi extends O {
  ...
  open(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.eventsDispatcher.emit(this.events.opened), this.popover = new ro({
      searchable: !0,
      ...
      messages: {
        nothingFound: oe.ui(de.ui.popover, "Nothing found"),
        search: oe.ui(de.ui.popover, "Filter")
      }
    }), this.popover.on(Xe.Close, this.onPopoverClose), this.nodes.wrapper.append(this.popover.getElement()), this.popover.show();
  }
  /**
...
class se extends O {
  ...
  make() {
    ...
    ]), this.nodes.tools = h.make("div", se.CSS.conversionToolbarTools);
    const e = h.make("div", se.CSS.conversionToolbarLabel, {
      textContent: oe.ui(de.ui.inlineToolbar.converter, "Convert to")
    });
  ...
  addTool(e, t) {
    var r;
    const o = h.make("div", [se.CSS.conversionTool]), i = h.make("div", [se.CSS.conversionToolIcon]);
    o.dataset.tool = e, i.innerHTML = t.icon, h.append(o, i), h.append(o, h.text(oe.t(de.toolNames, t.title || Re(e))));
    const s = (r = this.Editor.Tools.blockTools.get(e)) == null ? void 0 : r.shortcut;
    if (s) {
      const a = h.make("span", se.CSS.conversionToolSecondaryLabel, {
        innerText: yt(s)
      });
      h.append(o, a);
    }
...
const De = new Ji();
var es = Object.defineProperty, ts = Object.getOwnPropertyDescriptor, tn = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? ts(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && es(e, t, i), i;
}, ft = /* @__PURE__ */ ((n) => (n.Opened = "toolbox-opened", n.Closed = "toolbox-closed", n.BlockAdded = "toolbox-block-added", n))(ft || {});
const on = class extends wt {
  /**
   * Toolbox constructor
   *
  ...
  make() {
    ...
    }), this.popover.on(Xe.Close, this.onPopoverClose), this.enableShortcuts(), this.nodes.toolbox = this.popover.getElement(), this.nodes.toolbox.classList.add(on.CSS.toolbox), this.nodes.toolbox;
  }
  /**
  ...
  destroy() {
    var n;
    super.destroy(), this.nodes && this.nodes.toolbox && (this.nodes.toolbox.remove(), this.nodes.toolbox = null), this.removeAllShortcuts(), (n = this.popover) == null || n.off(Xe.Close, this.onPopoverClose);
  }
  /**
  ...
  get toolboxItemsToBeDisplayed() {
    const n = (e, t) => ({
      icon: e.icon,
      title: oe.t(de.toolNames, e.title || Re(t.name)),
      name: t.name,
      onActivate: () => {
        this.toolButtonActivated(t.name, e.data);
      },
      secondaryLabel: t.shortcut ? yt(t.shortcut) : ""
    });
  ...
  removeAllShortcuts() {
    this.toolsToBeDisplayed.forEach((n) => {
      const e = n.shortcut;
      e && De.remove(this.api.ui.nodes.redactor, e);
    });
  }
  /**
   * Inserts new block
  ...
  async insertNewBlock(n, e) {
    ...
    r.call(fe.APPEND_CALLBACK), this.api.caret.setToBlock(i), this.emit("toolbox-block-added", {
      block: r
...
tn([
  Fe
], ao.prototype, "toolsToBeDisplayed", 1);
tn([
  Fe
], ao.prototype, "toolboxItemsToBeDisplayed", 1);
...
class ns extends O {
    ...
    return {
      ...
      open: () => {
        if (this.toolboxInstance === null) {
          R("toolbox.open() called before initialization is finished", "warn");
          return;
        }
      ...
      toggle: () => {
        if (this.toolboxInstance === null) {
          R("toolbox.toggle() called before initialization is finished", "warn");
          return;
        }
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    if (this.toolboxInstance === null) {
      R("Can't open Toolbar since Editor initialization is not finished yet", "warn");
      return;
    }
  ...
  async make() {
    ...
    const e = h.make("div");
    e.appendChild(document.createTextNode(oe.ui(de.ui.toolbar.toolbox, "Add"))), e.appendChild(h.make("div", this.CSS.plusButtonShortcut, {
      textContent: "/"
    })), Ye(this.nodes.plusButton, e, {
      hidingDelay: 400
    }), this.nodes.settingsToggler = h.make("span", this.CSS.settingsToggler, {
      innerHTML: ji
    }), h.append(this.nodes.actions, this.nodes.settingsToggler);
    const t = h.make("div"), o = h.text(oe.ui(de.ui.blockTunes.toggler, "Click to tune")), i = await os("Slash", "/");
    t.appendChild(o), t.appendChild(h.make("div", this.CSS.plusButtonShortcut, {
      textContent: yt(`CMD + ${i}`)
    })), Ye(this.nodes.settingsToggler, t, {
      hidingDelay: 400
   ...
   */
  makeToolbox() {
    return this.toolboxInstance = new ao({
      api: this.Editor.API.methods,
      tools: this.Editor.Tools.blockTools,
      i18nLabels: {
        filter: oe.ui(de.ui.popover, "Filter"),
        nothingFound: oe.ui(de.ui.popover, "Nothing found")
      }
    }), this.toolboxInstance.on(ft.Opened, () => {
      this.Editor.UI.nodes.wrapper.classList.add(this.CSS.openedToolboxHolderModifier);
    }), this.toolboxInstance.on(ft.Closed, () => {
      this.Editor.UI.nodes.wrapper.classList.remove(this.CSS.openedToolboxHolderModifier);
    }), this.toolboxInstance.on(ft.BlockAdded, ({ block: e }) => {
  ...
  enableModuleBindings() {
    ...
    }, !0), Te() || this.eventsDispatcher.on(nn, (e) => {
      var t;
...
var Et = /* @__PURE__ */ ((n) => (n[n.Block = 0] = "Block", n[n.Inline = 1] = "Inline", n[n.Tune = 2] = "Tune", n))(Et || {}), gt = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.Toolbox = "toolbox", n.EnabledInlineTools = "inlineToolbar", n.EnabledBlockTunes = "tunes", n.Config = "config", n))(gt || {}), sn = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.SanitizeConfig = "sanitize", n))(sn || {}), _e = /* @__PURE__ */ ((n) => (n.IsEnabledLineBreaks = "enableLineBreaks", n.Toolbox = "toolbox", n.ConversionConfig = "conversionConfig", n.IsReadOnlySupported = "isReadOnlySupported", n.PasteConfig = "pasteConfig", n))(_e || {}), lo = /* @__PURE__ */ ((n) => (n.IsInline = "isInline", n.Title = "title", n))(lo || {}), rn = /* @__PURE__ */ ((n) => (n.IsTune = "isTune", n))(rn || {});
class co {
  /**
   * @class
...
class is extends O {
  ...
  close() {
    this.opened && (this.Editor.ReadOnly.isEnabled || (this.nodes.wrapper.classList.remove(this.CSS.inlineToolbarShowed), Array.from(this.toolsInstances.entries()).forEach(([e, t]) => {
      ...
      o && De.remove(this.Editor.UI.nodes.redactor, o), j(t.clear) && t.clear();
  ...
  addConversionToggler() {
    ...
    }), Te() === !1 && Ye(this.nodes.conversionToggler, oe.ui(de.ui.inlineToolbar.converter, "Convert to"), {
      placement: "top",
      hidingDelay: 100
    });
  }
  ...
  async addToolsFiltered(e = !0) {
    const t = x.get(), o = this.Editor.BlockManager.getBlock(t.anchorNode);
  ...
  addTool(e) {
    ...
    if (!o) {
      R("Render method must return an instance of Node", "warn", e.name);
      return;
    }
    ...
    const s = h.make("div"), r = oe.t(
      de.toolNames,
      e.title || Re(e.name)
    );
    s.appendChild(h.text(r)), i && s.appendChild(h.make("div", this.CSS.inlineToolbarShortcut, {
      textContent: yt(i)
    })), Te() === !1 && Ye(o, s, {
      placement: "top",
      hidingDelay: 100
  ...
  getToolShortcut(e) {
    ...
    return Array.from(i.keys()).includes(e) ? this.inlineTools[e][sn.Shortcut] : o.shortcut;
  }
  /**
...
class ss extends O {
  ...
  beforeKeydownProcessing(e) {
    this.needToolbarClosing(e) && $o(e.keyCode) && (this.Editor.Toolbar.close(), this.Editor.ConversionToolbar.close(), e.ctrlKey || e.metaKey || e.altKey || e.shiftKey || this.Editor.BlockSelection.clearSelection(e));
  }
  /**
   * Key up on Block:
  ...
  backspace(e) {
    ...
    No(i, s) ? this.mergeBlocks(s, i) : o.setToBlock(s, o.positions.END);
  }
  /**
   ...
   */
  arrowRightAndDown(e) {
    const t = be.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === C.TAB);
    ...
    if (e.keyCode === C.DOWN || e.keyCode === C.RIGHT && !this.isRtl ? this.Editor.Caret.navigateNext() : this.Editor.Caret.navigatePrevious()) {
      e.preventDefault();
      return;
    }
    bt(() => {
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (be.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === C.TAB))
        return;
    ...
    if (e.keyCode === C.UP || e.keyCode === C.LEFT && !this.isRtl ? this.Editor.Caret.navigatePrevious() : this.Editor.Caret.navigateNext()) {
      e.preventDefault();
      return;
    }
    bt(() => {
...
class Ht {
   ...
   */
  get nodes() {
    return Ko(this.workingArea.children);
  }
  /**
...
const Do = "block-removed", Po = "block-added", rs = "block-moved", Ho = "block-changed";
class as {
  constructor() {
...
class ls extends O {
   ...
   */
  prepare() {
    const e = new Ht(this.Editor.UI.nodes.redactor);
  ...
  composeBlock({
    ...
    const s = this.Editor.ReadOnly.isEnabled, r = this.Editor.Tools.blockTools.get(e), a = new V({
      id: o,
      data: t,
      tool: r,
      api: this.Editor.API,
  ...
  insert({
    ...
    return r && this.blockDidMutated(Do, this.getBlockByIndex(l), {
      index: l
    }), this._blocks.insert(l, c, r), this.blockDidMutated(Po, c, {
      index: l
  ...
  async update(e, t) {
    ...
    return this._blocks.replace(s, i), this.blockDidMutated(Ho, i, {
      index: s
    }), i;
  }
  /**
  ...
  paste(e, t, o = !1) {
    ...
    try {
      ...
      R(`${e}: onPaste callback call is failed`, "error", s);
    }
    return i;
  }
  /**
  ...
  insertDefaultBlockAtIndex(e, t = !1) {
    ...
    return this._blocks[e] = o, this.blockDidMutated(Po, o, {
      index: e
  ...
  async mergeBlocks(e, t) {
    ...
    ae(o) || await e.mergeWith(o), this.removeBlock(t), this.currentBlockIndex = this._blocks.indexOf(e);
  }
  /**
   * Remove passed Block
   *
  ...
  removeBlock(e, t = !0) {
    return new Promise((o) => {
      ...
      e.destroy(), this._blocks.remove(i), this.blockDidMutated(Do, e, {
        index: i
  ...
  getBlock(e) {
    ...
    const t = this._blocks.nodes, o = e.closest(`.${V.CSS.wrapper}`), i = t.indexOf(o);
    if (i >= 0)
  ...
  setCurrentBlockByChildNode(e) {
    h.isElement(e) || (e = e.parentNode);
    const t = e.closest(`.${V.CSS.wrapper}`);
    if (!t)
      return;
  ...
  move(e, t = this.currentBlockIndex) {
    if (isNaN(e) || isNaN(t)) {
      R("Warning during 'move' call: incorrect indices provided.", "warn");
      return;
    }
    if (!this.validateIndex(e) || !this.validateIndex(t)) {
      R("Warning during 'move' call: indices cannot be lower than 0 or greater than the amount of blocks.", "warn");
      return;
    }
    this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(rs, this.currentBlock, {
      fromIndex: t,
      toIndex: e
    });
  }
  ...
  async convert(e, t, o) {
    ...
    const r = await e.exportDataAsString(), a = ge(
      r,
      s.sanitizeConfig
    );
    let l = ai(a, s.conversionConfig);
  ...
  bindBlockEvents(e) {
    ...
    this.readOnlyMutableListeners.on(e.holder, "keydown", (o) => {
      ...
      t.dragLeave(o);
    }), e.on("didMutated", (o) => this.blockDidMutated(Ho, o, {
  ...
  blockDidMutated(e, t, o) {
    ...
    return this.eventsDispatcher.emit(Yo, {
      event: i
    }), t;
  }
}
class cs extends O {
  ...
  clearSelection(e, t = !1) {
    ...
    const r = e && e instanceof KeyboardEvent, a = r && $o(e.keyCode);
    if (this.anyBlockSelected && r && a && !x.isSelectionExists) {
      const l = o.removeSelectedBlocks();
      o.insertDefaultBlockAtIndex(l, !0), i.setToBlock(o.currentBlock), bt(() => {
        const c = e.key;
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((s) => {
      const r = ge(s.holder.innerHTML, this.sanitizerConfig), a = h.make("p");
...
class kt extends O {
  ...
  get isAtStart() {
    ...
    if (!e.focusable)
      return !0;
    const t = x.get(), o = h.getDeepestNode(e.currentInput);
    let i = t.focusNode;
    ...
    s === -1 && (s = 0);
    let r = t.focusOffset;
    return i.nodeType !== Node.TEXT_NODE && i.childNodes.length && (i.childNodes[r] ? (i = i.childNodes[r], r = 0) : (i = i.childNodes[r - 1], r = i.textContent.length)), (h.isLineBreakTag(o) || h.isEmpty(o)) && this.getHigherLevelSiblings(i, "left").every((c) => {
      const u = h.isLineBreakTag(c), d = c.children.length === 1 && h.isLineBreakTag(c.children[0]), p = u || d;
      return h.isEmpty(c) && !p;
  ...
  get isAtEnd() {
    ...
    const t = x.get();
    let o = t.focusNode;
    const i = h.getDeepestNode(e.currentInput, !0);
    if (h.isNativeInput(i))
      return i.selectionEnd === i.value.length;
    if (!t.focusNode)
      return !1;
    let s = t.focusOffset;
    if (o.nodeType !== Node.TEXT_NODE && o.childNodes.length && (o.childNodes[s - 1] ? (o = o.childNodes[s - 1], s = o.textContent.length) : (o = o.childNodes[0], s = 0)), h.isLineBreakTag(i) || h.isEmpty(i)) {
      const a = this.getHigherLevelSiblings(o, "right");
      if (a.every((c, u) => u === a.length - 1 && h.isLineBreakTag(c) || h.isEmpty(c) && !h.isLineBreakTag(c)) && s === o.textContent.length)
        return !0;
    }
   ...
   */
  set(e, t = 0) {
    const { top: i, bottom: s } = x.setCursor(e, t), { innerHeight: r } = window;
  ...
  createShadow(e) {
    ...
    t.classList.add(kt.CSS.shadowCaret), e.insertAdjacentElement("beforeend", t);
  }
  /**
   ...
   */
  restoreCaret(e) {
    const t = e.querySelector(`.${kt.CSS.shadowCaret}`);
    if (!t)
      return;
    new x().expandToTag(t);
...
var it = {};
it.__esModule = !0;
var fs = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(n) {
  return typeof n;
} : function(n) {
...
it.contains = gs;
function an(n) {
  n = n || {}, this.defaultProtocol = n.hasOwnProperty("defaultProtocol") ? n.defaultProtocol : re.defaultProtocol, this.events = n.hasOwnProperty("events") ? n.events : re.events, this.format = n.hasOwnProperty("format") ? n.format : re.format, this.formatHref = n.hasOwnProperty("formatHref") ? n.formatHref : re.formatHref, this.nl2br = n.hasOwnProperty("nl2br") ? n.nl2br : re.nl2br, this.tagName = n.hasOwnProperty("tagName") ? n.tagName : re.tagName, this.target = n.hasOwnProperty("target") ? n.target : re.target, this.validate = n.hasOwnProperty("validate") ? n.validate : re.validate, this.ignoreTags = [], this.attributes = n.attributes || n.linkAttributes || re.attributes, this.className = n.hasOwnProperty("className") ? n.className : n.linkClass || re.className;
  for (var e = n.hasOwnProperty("ignoreTags") ? n.ignoreTags : re.ignoreTags, t = 0; t < e.length; t++)
...
an.prototype = {
  ...
  get: function(e, t, o) {
    ...
    if (!s)
      return s;
    switch (typeof s > "u" ? "undefined" : fs(s)) {
      case "function":
        return s(t, o.type);
      case "object":
        return i = s.hasOwnProperty(o.type) ? s[o.type] : re[e], typeof i == "function" ? i(t, o.type) : i;
    }
    return s;
  },
...
var ue = {}, me = {};
me.__esModule = !0;
me.stateify = me.TokenState = me.CharacterState = void 0;
var ln = ze;
function uo() {
  return function(n) {
...
function ks(n, e, t, o) {
  ...
  if (i >= s)
    return [];
  for (; i < s - 1; )
    l = new Gt(o), a.push(l), r.on(n[i], l), r = l, i++;
  return l = new Gt(t), a.push(l), r.on(n[s - 1], l), a;
}
me.CharacterState = Gt;
me.TokenState = bs;
me.stateify = ks;
var v = {}, Tt = {};
Tt.__esModule = !0;
...
var cn = Tt, xs = ze, fo = (0, cn.createTokenClass)();
fo.prototype = {
  toString: function() {
    return this.v + "";
  }
...
function F(n) {
  var e = n ? { v: n } : {};
  return (0, xs.inherits)(fo, (0, cn.createTokenClass)(), e);
}
var ys = F(), ws = F("@"), Es = F(":"), Ts = F("."), Ss = F(), Cs = F(), Bs = F(`
`), As = F(), Os = F("+"), Ls = F("#"), Is = F(), Ms = F("mailto:"), _s = F("?"), Ns = F("/"), Rs = F("_"), Ds = F(), Ps = F(), Hs = F(), Fs = F("{"), zs = F("["), Us = F("<"), js = F("("), $s = F("}"), Ks = F("]"), qs = F(">"), Ws = F(")"), Vs = F("&");
v.Base = fo;
v.DOMAIN = ys;
v.AT = ws;
v.COLON = Es;
...
v.OPENBRACE = Fs;
v.OPENBRACKET = zs;
v.OPENANGLEBRACKET = Us;
v.OPENPAREN = js;
v.CLOSEBRACE = $s;
v.CLOSEBRACKET = Ks;
v.CLOSEANGLEBRACKET = qs;
v.CLOSEPAREN = Ws;
v.AMPERSAND = Vs;
ue.__esModule = !0;
ue.start = ue.run = ue.TOKENS = ue.State = void 0;
var xe = me, A = v, Ys = Xs(A);
function Xs(n) {
  if (n && n.__esModule)
    return n;
  var e = {};
...
Ct.on(":", Bt);
er.on(":", tr);
var or = (0, xe.stateify)("localhost", le, A.LOCALHOST, A.DOMAIN);
ee.push.apply(ee, or);
le.on(go, Zt);
Zt.on("-", Ge).on(go, Zt).on(St, Pe);
Pe.on("-", Ge).on(St, Pe);
for (var zt = 0; zt < ee.length; zt++)
  ee[zt].on("-", Ge).on(St, Pe);
Ge.on("-", Ge).on(go, Pe).on(St, Pe);
le.defaultTransition = H(A.SYM);
var nr = function(e) {
  for (var t = e.replace(/[A-Z]/g, function(p) {
    return p.toLowerCase();
  }), o = e.length, i = [], s = 0; s < o; ) {
    for (var r = le, a = null, l = 0, c = null, u = -1; s < o && (a = r.next(t[s])); )
      r = a, r.accepts() ? (u = 0, c = r) : u >= 0 && u++, l++, s++;
    if (!(u < 0)) {
      s -= u, l -= u;
      var d = c.emit();
...
ue.State = xe.CharacterState;
ue.TOKENS = Ys;
ue.run = nr;
ue.start = ir;
var pe = {}, te = {};
te.__esModule = !0;
te.URL = te.TEXT = te.NL = te.EMAIL = te.MAILTOEMAIL = te.Base = void 0;
var Ue = Tt, st = ze, We = v;
function sr(n) {
  return n instanceof We.DOMAIN || n instanceof We.TLD;
}
var Le = (0, Ue.createTokenClass)();
Le.prototype = {
  /**
...
var rr = (0, st.inherits)(Le, (0, Ue.createTokenClass)(), {
  type: "email",
  isLink: !0
}), ar = (0, st.inherits)(Le, (0, Ue.createTokenClass)(), {
  type: "email",
  isLink: !0,
  toHref: function() {
    return "mailto:" + this.toString();
  }
}), lr = (0, st.inherits)(Le, (0, Ue.createTokenClass)(), { type: "text" }), cr = (0, st.inherits)(Le, (0, Ue.createTokenClass)(), { type: "nl" }), dr = (0, st.inherits)(Le, (0, Ue.createTokenClass)(), {
  type: "url",
  isLink: !0,
  /**
...
var L = function(e) {
  return new gn.TokenState(e);
}, At = L(), mn = L(), bn = L(), mo = L(), kn = L(), ke = L(), Ot = L(), rt = L(ne.URL), vn = L(), xn = L(ne.URL), $ = L(ne.URL), Ze = L(), at = L(), lt = L(), ct = L(), dt = L(), Ce = L(ne.URL), Be = L(ne.URL), Ae = L(ne.URL), Oe = L(ne.URL), Qe = L(), Je = L(), et = L(), tt = L(), Ne = L(), bo = L(), Lt = L(ne.EMAIL), yn = L(), pr = L(ne.EMAIL), Ee = L(ne.MAILTOEMAIL), Jt = L(), He = L(), It = L(), wn = L(), fr = L(ne.NL);
At.on(g.NL, fr).on(g.PROTOCOL, mn).on(g.MAILTO, bn).on(g.SLASH, mo);
mn.on(g.SLASH, mo);
mo.on(g.SLASH, kn);
At.on(g.TLD, ke).on(g.DOMAIN, ke).on(g.LOCALHOST, rt).on(g.NUM, ke);
kn.on(g.TLD, $).on(g.DOMAIN, $).on(g.NUM, $).on(g.LOCALHOST, $);
ke.on(g.DOT, Ot);
Ne.on(g.DOT, bo);
Ot.on(g.TLD, rt).on(g.DOMAIN, ke).on(g.NUM, ke).on(g.LOCALHOST, ke);
bo.on(g.TLD, Lt).on(g.DOMAIN, Ne).on(g.NUM, Ne).on(g.LOCALHOST, Ne);
rt.on(g.DOT, Ot);
Lt.on(g.DOT, bo);
rt.on(g.COLON, vn).on(g.SLASH, $);
vn.on(g.NUM, xn);
xn.on(g.SLASH, $);
Lt.on(g.COLON, yn);
yn.on(g.NUM, pr);
...
$.on(g.OPENBRACE, at).on(g.OPENBRACKET, lt).on(g.OPENANGLEBRACKET, ct).on(g.OPENPAREN, dt);
Ze.on(g.OPENBRACE, at).on(g.OPENBRACKET, lt).on(g.OPENANGLEBRACKET, ct).on(g.OPENPAREN, dt);
at.on(g.CLOSEBRACE, $);
lt.on(g.CLOSEBRACKET, $);
ct.on(g.CLOSEANGLEBRACKET, $);
dt.on(g.CLOSEPAREN, $);
Ce.on(g.CLOSEBRACE, $);
Be.on(g.CLOSEBRACKET, $);
Ae.on(g.CLOSEANGLEBRACKET, $);
Oe.on(g.CLOSEPAREN, $);
Qe.on(g.CLOSEBRACE, $);
Je.on(g.CLOSEBRACKET, $);
et.on(g.CLOSEANGLEBRACKET, $);
tt.on(g.CLOSEPAREN, $);
at.on(Z, Ce);
lt.on(Z, Be);
ct.on(Z, Ae);
...
$.on(Q, Ze);
Ze.on(Q, Ze);
bn.on(g.TLD, Ee).on(g.DOMAIN, Ee).on(g.NUM, Ee).on(g.LOCALHOST, Ee);
Ee.on(Z, Ee).on(Q, Jt);
Jt.on(Z, Ee).on(Q, Jt);
var ht = [g.DOMAIN, g.NUM, g.PLUS, g.POUND, g.QUERY, g.UNDERSCORE, g.SYM, g.AMPERSAND, g.TLD];
ke.on(ht, He).on(g.AT, It);
rt.on(ht, He).on(g.AT, It);
Ot.on(ht, He);
He.on(ht, He).on(g.AT, It).on(g.DOT, wn);
wn.on(ht, He);
It.on(g.TLD, Ne).on(g.DOMAIN, Ne).on(g.LOCALHOST, Lt);
var gr = function(e) {
  for (var t = e.length, o = 0, i = [], s = []; o < t; ) {
    for (var r = At, a = null, l = null, c = 0, u = null, d = -1; o < t && !(a = r.next(e[o])); )
      s.push(e[o++]);
    ...
    if (d < 0)
      ...
      s.length > 0 && (i.push(new ne.TEXT(s)), s = []), o -= d, c -= d;
      var b = u.emit();
      i.push(new b(e.slice(o - c, o)));
    }
  }
  return s.length > 0 && i.push(new ne.TEXT(s)), i;
};
pe.State = gn.TokenState;
pe.TOKENS = hr;
pe.run = gr;
pe.start = At;
Y.__esModule = !0;
Y.tokenize = Y.test = Y.scanner = Y.parser = Y.options = Y.inherits = Y.find = void 0;
var mr = ze, br = it, kr = ko(br), vr = ue, En = ko(vr), xr = pe, Tn = ko(xr);
function ko(n) {
  if (n && n.__esModule)
    return n;
  var e = {};
...
var vo = function(e) {
  return Tn.run(En.run(e));
}, yr = function(e) {
  for (var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, o = vo(e), i = [], s = 0; s < o.length; s++) {
    var r = o[s];
    r.isLink && (!t || r.type === t) && i.push(r.toObject());
  }
  return i;
}, wr = function(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, o = vo(e);
  return o.length === 1 && o[0].isLink && (!t || o[0].type === t);
};
Y.find = yr;
Y.inherits = mr.inherits;
Y.options = kr;
Y.parser = Tn;
Y.scanner = En;
Y.test = wr;
...
var Sr = Sn.tokenize, Cr = Sn.options, Br = Cr.Options;
function Uo(n) {
...
function eo(n) {
  ...
  e = new Br(e);
  for (var t = Sr(n), o = [], i = 0; i < t.length; i++) {
    var s = t[i];
...
`);
      ...
      o.push(Uo(s.toString()));
      continue;
    }
    var r = e.resolve(s), a = r.formatted, l = r.formattedHref, c = r.tagName, u = r.className, d = r.target, p = r.attributes, b = "<" + c + ' href="' + mt(l) + '"';
    u && (b += ' class="' + mt(u) + '"'), d && (b += ' target="' + mt(d) + '"'), p && (b += " " + Ar(p)), b += ">" + Uo(a) + "</" + c + ">", o.push(b);
  }
  return o.join("");
}
...
var Ir = /^#[xX]([A-Fa-f0-9]+)$/, Mr = /^#([0-9]+)$/, _r = /^([A-Za-z0-9]+)$/;
Cn.prototype.parse = function(n) {
  if (n) {
    var e = n.match(Ir);
    if (e)
      return "&#x" + e[1] + ";";
...
Bn.prototype = {
  ...
  tokenizePart: function(e) {
    for (this.input += (0, he.preprocessInput)(e); this.index < this.input.length; )
...
` ? (this.line++, this.column = 0) : this.column++, e;
  ...
  states: {
    ...
    tagOpen: function() {
      var e = this.consume();
      e === "!" ? this.state = "markupDeclaration" : e === "/" ? this.state = "endTagOpen" : (0, he.isAlpha)(e) && (this.state = "tagName", this.delegate.beginStartTag(), this.delegate.appendToTagName(e.toLowerCase()));
    },
    ...
    tagName: function() {
      var e = this.consume();
      (0, he.isSpace)(e) ? this.state = "beforeAttributeName" : e === "/" ? this.state = "selfClosingStartTag" : e === ">" ? (this.delegate.finishTag(), this.state = "beforeData") : this.delegate.appendToTagName(e);
    },
    ...
    beforeAttributeValue: function() {
      var e = this.peek();
      (0, he.isSpace)(e) ? this.consume() : e === '"' ? (this.state = "attributeValueDoubleQuoted", this.delegate.beginAttributeValue(!0), this.consume()) : e === "'" ? (this.state = "attributeValueSingleQuoted", this.delegate.beginAttributeValue(!0), this.consume()) : e === ">" ? (this.delegate.beginAttributeValue(!1), this.delegate.finishAttributeValue(), this.consume(), this.delegate.finishTag(), this.state = "beforeData") : (this.state = "attributeValueUnquoted", this.delegate.beginAttributeValue(!1), this.consume(), this.delegate.appendToAttributeValue(e));
    },
    ...
    attributeValueUnquoted: function() {
      var e = this.peek();
      (0, he.isSpace)(e) ? (this.delegate.finishAttributeValue(), this.consume(), this.state = "beforeAttributeName") : e === "&" ? (this.consume(), this.delegate.appendToAttributeValue(this.consumeCharRef(">") || "&")) : e === ">" ? (this.delegate.finishAttributeValue(), this.consume(), this.delegate.finishTag(), this.state = "beforeData") : (this.consume(), this.delegate.appendToAttributeValue(e));
    },
    afterAttributeValueQuoted: function() {
      var e = this.peek();
      (0, he.isSpace)(e) ? (this.consume(), this.state = "beforeAttributeName") : e === "/" ? (this.consume(), this.state = "selfClosingStartTag") : e === ">" ? (this.consume(), this.delegate.finishTag(), this.state = "beforeData") : this.state = "beforeAttributeName";
    },
    ...
    endTagOpen: function() {
      var e = this.consume();
      (0, he.isAlpha)(e) && (this.state = "tagName", this.delegate.beginEndTag(), this.delegate.appendToTagName(e.toLowerCase()));
    }
  }
};
Nt.default = Bn;
...
function An(n, e) {
  this.token = null, this.startLine = 1, this.startColumn = 0, this.options = e || {}, this.tokenizer = new Ur.default(this, n);
}
An.prototype = {
  tokenize: function(e) {
...
wo.__esModule = !0;
wo.default = Xr;
var $r = Rt, Kr = Eo($r), qr = _t, Wr = Eo(qr), Vr = Mt, Yr = Eo(Vr);
function Eo(n) {
  return n && n.__esModule ? n : { default: n };
}
function Xr(n, e) {
  var t = new Kr.default(new Wr.default(Yr.default), e);
  return t.tokenize(n);
}
yo.__esModule = !0;
var Gr = Mt, Zr = pt(Gr), Qr = _t, Jr = pt(Qr), ea = Nt, ta = pt(ea), oa = Rt, na = pt(oa), ia = wo, sa = pt(ia);
function pt(n) {
  return n && n.__esModule ? n : { default: n };
}
var ra = {
  ...
  EventedTokenizer: ta.default,
  Tokenizer: na.default,
  tokenize: sa.default
};
yo.default = ra;
xo.__esModule = !0;
xo.default = fa;
var aa = yo, la = ha(aa), ca = Y, On = da(ca);
function da(n) {
  if (n && n.__esModule)
    return n;
  var e = {};
...
var Ln = On.options, ua = Ln.Options, ot = "StartTag", To = "EndTag", vt = "Chars", pa = "Comment";
function fa(n) {
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, t = la.default.tokenize(n), o = [], i = [], s;
  for (e = new ua(e), s = 0; s < t.length; s++) {
    var r = t[s];
    if (r.type === ot) {
      o.push(r);
      var a = r.tagName.toUpperCase(), l = a === "A" || Ln.contains(e.ignoreTags, a);
      if (!l)
        continue;
      var c = o.length;
      ma(a, t, ++s, o), s += o.length - c - 1;
      continue;
    } else if (r.type !== vt) {
      o.push(r);
      continue;
...
function ga(n, e) {
  for (var t = On.tokenize(n), o = [], i = 0; i < t.length; i++) {
    var s = t[i];
    if (s.type === "nl" && e.nl2br) {
      o.push({
        type: ot,
      ...
      o.push({ type: vt, chars: s.toString() });
      continue;
    }
    var r = e.resolve(s), a = r.formatted, l = r.formattedHref, c = r.tagName, u = r.className, d = r.target, p = r.attributes, b = [["href", l]];
    u && b.push(["class", u]), d && b.push(["target", d]);
    for (var f in p)
      b.push([f, p[f]]);
    o.push({
      type: ot,
      ...
      attributes: b,
      selfClosing: !1
    }), o.push({ type: vt, chars: a }), o.push({ type: To, tagName: c });
  }
  return o;
}
function ma(n, e, t, o) {
  for (var i = 1; t < e.length && i > 0; ) {
    var s = e[t];
    s.type === ot && s.tagName.toUpperCase() === n ? i++ : s.type === To && s.tagName.toUpperCase() === n && i--, o.push(s), t++;
  }
  return o;
}
function ba(n) {
...
const In = class extends O {
  ...
  async processDataTransfer(n, e = !1) {
    ...
    if ((o.includes ? o.includes("Files") : o.contains("Files")) && !ae(this.toolsFiles)) {
    ...
    const l = Object.keys(this.toolsTags).reduce((d, p) => (d[p.toLowerCase()] = this.toolsTags[p].sanitizationConfig ?? {}, d), {}), c = Object.assign({}, l, t.getAllInlineToolsSanitizeConfig(), { br: {} }), u = ge(a, c);
  ...
  async processText(n, e = !1) {
    const { Caret: t, BlockManager: o } = this.Editor, i = e ? this.processHTML(va(n)) : this.processPlain(n);
    if (!i.length)
      return;
    if (i.length === 1) {
   ...
   */
  collectTagNames(n) {
    return ve(n) ? [n] : X(n) ? Object.keys(n) : [];
  }
  /**
  ...
  getFilesConfig(n) {
    ...
    !t && !o || (t && !Array.isArray(t) && (R(`«extensions» property of the onDrop config for «${n.name}» Tool should be an array`), t = []), o && !Array.isArray(o) && (R(`«mimeTypes» property of the onDrop config for «${n.name}» Tool should be an array`), o = []), o && (o = o.filter((i) => Yn(i) ? !0 : (R(`MIME type value «${i}» for the «${n.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[n.name] = {
      extensions: t || [],
      mimeTypes: o || []
    });
  }
   ...
   */
  getPatternsConfig(n) {
    n.pasteConfig === !1 || !n.pasteConfig.patterns || ae(n.pasteConfig.patterns) || Object.entries(n.pasteConfig.patterns).forEach(([e, t]) => {
      t instanceof RegExp || R(
   ...
   */
  async processFile(n) {
    const e = Vn(n), t = Object.entries(this.toolsFiles).find(([s, { mimeTypes: r, extensions: a }]) => {
      const [l, c] = n.type.split("/"), u = a.find((p) => p.toLowerCase() === e.toLowerCase()), d = r.find((p) => {
        const [b, f] = p.split("/");
        return b === l && (f === c || f === "*");
      });
      return !!u || !!d;
  ...
  processHTML(n) {
    ...
    return t.innerHTML = n, this.getNodes(t).map((i) => {
      ...
      const { tags: l } = r.pasteConfig || { tags: [] }, c = l.reduce((p, b) => (this.collectTagNames(b).forEach((y) => {
        const P = X(b) ? b[y] : null;
        p[y.toLowerCase()] = P || {};
      }), p), {}), u = Object.assign({}, c, r.baseSanitizeConfig);
      if (s.tagName.toLowerCase() === "table") {
        const p = ge(s.outerHTML, u);
        s = h.make("div", void 0, {
          innerHTML: p
        }).firstChild;
      } else
        s.innerHTML = ge(s.innerHTML, u);
      ...
      const s = h.isEmpty(i.content), r = h.isSingleTag(i.content);
      return !s || r;
    });
  }
  /**
  ...
  async processSingleBlock(n) {
    ...
    if (!o || n.tool !== o.name || !h.containsOnlyInlineElements(n.content.innerHTML)) {
  ...
  async processInlinePaste(n) {
    ...
    if (e.currentBlock && e.currentBlock.tool.isDefault && o.textContent.length < In.PATTERN_PROCESSING_MAX_LENGTH) {
  ...
  processElementNode(n, e, t) {
    const o = Object.keys(this.toolsTags), i = n, { tool: s } = this.toolsTags[i.tagName] || {}, r = this.tagsByTool[s == null ? void 0 : s.name] || [], a = o.includes(i.tagName), l = h.blockElements.includes(i.tagName.toLowerCase()), c = Array.from(i.children).some(
      ({ tagName: d }) => o.includes(d) && !r.includes(d)
    ), u = Array.from(i.children).some(
      ({ tagName: d }) => h.blockElements.includes(d.toLowerCase())
    );
    if (!l && !a && !c)
  ...
  getNodes(n) {
    ...
    const o = (i, s) => {
      ...
      switch (r && h.isFragment(r) && (a = i.pop()), s.nodeType) {
        case Node.ELEMENT_NODE:
...
let Mn = In;
Mn.PATTERN_PROCESSING_MAX_LENGTH = 450;
class xa extends O {
  constructor() {
...
class Ve extends O {
  ...
  enableModuleBindings() {
    ...
    }, !1), this.listeners.on(document.body, "mousemove", Ut((t) => {
      this.processMouseMove(t);
    }, 10), {
      passive: !0
    }), this.listeners.on(document.body, "mouseleave", () => {
      this.processMouseLeave();
    }), this.listeners.on(window, "scroll", Ut((t) => {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = h.make("div", Ve.CSS.overlay, {}), i = h.make("div", Ve.CSS.overlayContainer, {}), s = h.make("div", Ve.CSS.rect, {});
  ...
  genInfoForMouseSelection() {
    ...
    const a = this.Editor.BlockManager.lastBlock.holder.querySelector("." + V.CSS.content), l = Number.parseInt(window.getComputedStyle(a).width, 10) / 2, c = t - l, u = t + l;
    return {
      index: r,
      leftPos: c,
      rightPos: u
      ...
      if (e.length === 0)
        ...
        const s = e.map(({ type: r, data: a, tunes: l, id: c }) => {
          ...
          try {
            ...
            R(`Block «${r}» skipped because of plugins error`, "error", {
              data: a,
              error: d
...
class wa extends O {
  ...
  async save() {
    ...
    try {
      ...
      const s = await Promise.all(i), r = await Zo(s, (a) => t.blockTools.get(a).sanitizeConfig);
      return this.makeOutput(r);
    } catch (s) {
      ce("Saving failed due to the Error %o", "error", s);
    }
  }
  /**
   * Saves and validates
  ...
  makeOutput(e) {
    ...
    return e.forEach(({ id: o, tool: i, data: s, tunes: r, isValid: a }) => {
      if (!a) {
        R(`Block «${i}» skipped because saved data is invalid`);
        return;
      }
...
(function(n, e) {
  (function(t, o) {
    ...
    return function(t) {
      ...
      function u(T, w) {
        for (var E = {}, M = [], U = 0; U < T.length; U++) {
          var k = T[U], m = w.base ? k[0] + w.base : k[0], S = E[m] || 0, B = "".concat(m, " ").concat(S);
          E[m] = S + 1;
          var D = c(B), I = { css: k[1], media: k[2], sourceMap: k[3] };
          D !== -1 ? (l[D].references++, l[D].updater(I)) : l.push({ identifier: B, updater: N(I, w), references: 1 }), M.push(B);
        }
        return M;
      }
      function d(T) {
...
`);
      ...
      function f(T, w, E, M) {
        var U = E ? "" : M.media ? "@media ".concat(M.media, " {").concat(M.css, "}") : M.css;
        if (T.styleSheet)
          T.styleSheet.cssText = b(w, U);
        else {
          var k = document.createTextNode(U), m = T.childNodes;
          m[w] && T.removeChild(m[w]), m.length ? T.insertBefore(k, m[w]) : T.appendChild(k);
        }
      }
      function y(T, w, E) {
        var M = E.css, U = E.media, k = E.sourceMap;
        if (U ? T.setAttribute("media", U) : T.removeAttribute("media"), k && btoa && (M += `
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(k)))), " */")), T.styleSheet)
      ...
      function N(T, w) {
        ...
        if (w.singleton) {
          var k = z++;
          E = P || (P = d(w)), M = f.bind(null, E, k, !1), U = f.bind(null, E, k, !0);
        } else
          E = d(w), M = y.bind(null, E, w), U = function() {
            (function(m) {
      ...
      t.exports = function(T, w) {
        ...
        return function(M) {
          if (M = M || [], Object.prototype.toString.call(M) === "[object Array]") {
            ...
            for (var m = u(M, w), S = 0; S < E.length; S++) {
              var B = c(E[S]);
          ...
          return this.map(function(a) {
            var l = function(c, u) {
              ...
              if (u && typeof btoa == "function") {
                var b = (y = p, P = btoa(unescape(encodeURIComponent(JSON.stringify(y)))), z = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(P), "/*# ".concat(z, " */")), f = p.sources.map(function(N) {
                  return "/*# sourceURL=".concat(p.sourceRoot || "").concat(N, " */");
                });
...
`);
      ...
      var a = function() {
        function l(c) {
          var u = c.data, d = c.config, p = c.api, b = c.readOnly;
          (function(f, y) {
            if (!(f instanceof y))
              throw new TypeError("Cannot call a class as a function");
...
class So {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = Pi, this.nodes.button;
  }
  /**
...
class Co {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = Ui, this.nodes.button;
  }
  /**
...
class Bo {
  ...
  checkState() {
    ...
    if (e) {
      this.nodes.button.innerHTML = qi, this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
  ...
  enterPressed(e) {
    ...
    if (!this.validateURL(t)) {
      this.notifier.show({
        ...
        style: "error"
      }), R("Incorrect Link pasted", "warn", t);
      return;
    }
...
class _n {
   ...
   */
  make() {
    const e = h.make("div", this.CSS.wrapper), t = Wi, o = h.make("div", this.CSS.info), i = h.make("div", this.CSS.title, {
...
_n.isReadOnlySupported = !0;
class Sa extends co {
  constructor() {
    super(...arguments), this.type = Et.Inline;
  }
  /**
   * Returns title for Inline Tool if specified by user
   */
  get title() {
    return this.constructable[lo.Title];
  }
  /**
...
class Ca extends co {
  constructor() {
    super(...arguments), this.type = Et.Tune;
  }
  /**
...
var Ba = Object.defineProperty, Aa = Object.getOwnPropertyDescriptor, Nn = (n, e, t, o) => {
...
class Ao extends co {
  constructor() {
    super(...arguments), this.type = Et.Block, this.inlineTools = new G(), this.tunes = new G();
  }
  /**
   ...
   */
  get toolbox() {
    const e = this.constructable[_e.Toolbox], t = this.config[gt.Toolbox];
    if (!ae(e) && t !== !1)
...
Nn([
  Fe
], Ao.prototype, "sanitizeConfig", 1);
Nn([
  Fe
], Ao.prototype, "baseSanitizeConfig", 1);
class Oa {
  /**
   * @class
...
Pn.isTune = !0;
var La = Object.defineProperty, Ia = Object.getOwnPropertyDescriptor, Ma = (n, e, t, o) => {
...
class Hn extends O {
   ...
   */
  async prepare() {
    if (this.validateTools(), this.config.tools = jt({}, this.internalTools, this.config.tools), !Object.prototype.hasOwnProperty.call(this.config, "tools") || Object.keys(this.config.tools).length === 0)
      throw Error("Can't start without tools");
    const e = this.prepareConfig();
    this.factory = new Oa(e, this.config, this.Editor.API);
...
class Na extends O {
  ...
  get contentRect() {
    ...
    const e = this.nodes.wrapper.querySelector(`.${V.CSS.content}`);
   ...
   */
  checkIsMobile() {
    this.isMobile = window.innerWidth < qo;
  }
  /**
  ...
  loadStyles() {
    ...
    const t = h.make("style", null, {
      id: e,
      textContent: _a.toString()
    });
    this.config.style && !ae(this.config.style) && this.config.style.nonce && t.setAttribute("nonce", this.config.style.nonce), h.prepend(document.head, t);
  }
  /**
  ...
  watchBlockHoveredEvents() {
    let e;
    this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", Ut((t) => {
      const o = t.target.closest(".ce-block");
      this.Editor.BlockSelection.anyBlockSelected || o && e !== o && (e = o, this.eventsDispatcher.emit(nn, {
  ...
  redactorClicked(e) {
    ...
    if (h.isAnchor(t) && o) {
      ...
      const i = t.getAttribute("href"), s = Gn(i);
      Qn(s);
      return;
    }
  ...
  selectionChanged() {
    ...
    const i = o.closest(`.${V.CSS.content}`) === null;
...
const Ra = {
  ...
  BlockSelection: cs,
  Caret: kt,
  CrossBlockSelection: ds,
  DragNDrop: hs,
  ModificationsObserver: us,
  Paste: Mn,
  ReadOnly: xa,
...
class Da {
  ...
  constructor(e) {
    ...
    this.isReady = new Promise((i, s) => {
      ...
      R(`Editor.js is not ready because of ${i}`, "error"), o(i);
    });
  }
  /**
  ...
  set configuration(e) {
    ...
    X(e) ? this.config = {
      ...
      holder: e
    }, $t(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = jo.VERBOSE), Kn(this.config.logLevel), $t(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const t = {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (ae(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && oe.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
    ...
    await [
      ...
      (t, o) => t.then(async () => {
        try {
          ...
          R(`Module ${o} was skipped because of %o`, "warn", i);
        }
      }),
      Promise.resolve()
    );
  ...
  constructModules() {
    Object.entries(Ra).forEach(([e, t]) => {
      try {
        ...
        R("[constructModules]", `Module ${e} skipped because`, "error", o);
      }
    });
  }
  /**
